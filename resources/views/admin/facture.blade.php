...
@section('content')
    ...
    <main id="main" class="main">
        ...
        @endif
        <input type="hidden" name="estAutoriserDeModifLevelWarning" id="estAutoriserDeModifLevelWarning"
            value={{ Auth::user()->roles->estAutoriserDeModifLevelWarning }}>
        <!-- Modal -->
        ...
        <div class="pagetitle row justify-content-between align-items-center">
            <div class="col-md-8 row">
                ...
                <div class="col-md-8 d-flex justify-content-start pt-3">
                    ...
                    <button style="font-size: 11px" id="updateStock"
                        class=" mb-1 form-control form-control-sm d-block d-sm-none btn btn-primary">
                        <i class="fas fa-sync"></i> Mettre à jour le stock
                    </button>
                    <button type="button" class="form-control d-none d-sm-block btn btn-primary" data-toggle="modal"
                        data-target="#exampleModal">
                        <i class="fas fa-file-invoice"></i> Créer une facture
                    </button>
                    <button style="font-size: 11px" type="button"
                        class="mb-1 form-control form-control-sm d-block d-sm-none btn btn-primary" data-toggle="modal"
                        data-target="#exampleModal">
                        <i class="fas fa-file-invoice"></i> Créer une facture
                    </button>
                </div>
            ...
            <div class="col-md-4 d-flex justify-content-between">
                <a href="{{ route('paiement.facture') }}" id="bills"
                    class="form-control d-none d-sm-block btn btn-success">
                    <i class="fas fa-file-invoice"></i> Factures
                </a>
                <a href="{{ route('paiement.facture') }}" style="font-size: 11px" id="bills"
                    class="form-control form-control-sm d-block d-sm-none  btn btn-success">
                    <i class="fas fa-file-invoice"></i> Factures
                </a>
                ...
                <button style="font-size: 11px" id="oldBills2"
                    class="form-control form-control-sm d-block d-sm-none btn btn-secondary">
                    <i class="fas fa-history"></i> factures
                </button>
                <button id="filterStatus" class="form-control d-none d-sm-block btn btn-danger">
                    <i class="fas fa-trash-alt"></i> Corbeille
                </button>
                <button style="font-size: 11px" id="filterStatus2"
                    class="form-control form-control-sm d-block d-sm-none btn btn-danger">
                    <i class="fas fa-trash-alt"></i> Corbeille
                </button>
                ...
                <div class="col-12 main-datatable">
                    <div class="card_body">
                        <div class="row d-flex">
                            ...
                            <!-- Modal -->
                            <!-- ---- modal OLD facture ---- -->
                            <div style="--bs-modal-width: 1000px !important;" class="modal fade " id="oldBillsModal"
                                                            ...
                                                            <div class="col-12 add_flex justify-content-center mt-4">
                                                                <div class="text-center pt-3 pb-2">
                                                                    <img style="width: 100px"
                                                                        src="{{ asset('assets\images\family.png') }}"
                                                                        alt="Check" width="60">
                            ...
                            <div style="--bs-modal-width: 55vw !important; height: 80vh !important; overflow-y: auto;"
                                class="modal fade " id="factureFamille" tabindex="-1" role="dialog"
                                                ...
                                                <div class="col-12 main-datatable"
                                                    ...
                                                    <div class="card_body">
                                                        <div class="row d-flex">
                                                            ...
                                                            <div class="row modal-body overflow-x"
                                                                id="familyBillsContainer">
                                                                <!-- content -->
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <div class="overflow-x">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" id="customSearch" class="form-control" placeholder="Recherche..."
                                    aria-label="Recherche" aria-describedby="search-addon" autocomplete="off">
