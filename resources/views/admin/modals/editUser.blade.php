                ...
                <div class="lastname">
                    <div class="form-group">
                        ...
                        <input class="form-control @error('lastname') is-invalid @enderror" type="text" id="lastname"
                            name="lastname" value="{{ $n_users->lastname }}"
                            {{ (auth()->user()->role < $n_users->role && auth()->user()->user_id != $n_users->user_id) ? 'readonly' : '' }} />
                ...
                <div class="username">
                    <div class="form-group">
                        ...
                        <input class="form-control @error('username') is-invalid @enderror" type="text" id="username"
                            name="username" value="{{ $n_users->username }}"
                            {{ (auth()->user()->role < $n_users->role && auth()->user()->user_id != $n_users->user_id) ? 'readonly' : '' }} />
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input class="form-control @error('address') is-invalid @enderror" type="text" id="address"
                            name="address" value="{{ $n_users->address }}"
                            {{ (auth()->user()->role < $n_users->role && auth()->user()->user_id != $n_users->user_id) ? 'readonly' : '' }} />
                ...
                <div class="col-sm-4 input mt-2">
                    ...
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" id="crt_delete" name="crt_delete" value="1"
                            @if(auth()->user()->role < $n_users->role && auth()->user()->user_id !=
            ...
            <div class="row" style="--bs-gutter-x: 0.5rem;">
                ...
                <div class="col-md-4">
                    ...
                    <input type="date" id="created_at" placeholder=" " name="created_at"
                        ...
                        value="{{ $n_users->created_at->format('Y-m-d') }}" @if(auth()->user()->role < $n_users->role &&
                        auth()->user()->user_id !=
                        $n_users->user_id) disabled @endif>
                        @error('created_at')
                        <span class="text-danger" role="alert">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" id="licenceFFGYM" placeholder=" " name="licenceFFGYM"
                        ...
                        value="{{ $n_users->licenceFFGYM }}" @if(auth()->user()->role < $n_users->role &&
                        auth()->user()->user_id !=
                        $n_users->user_id) disabled @endif>
                        @error('licenceFFGYM')
                        <span class="text-danger" role="alert">
