                            ...
                            <td>
                                        ...
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-12 text-center my-3">
                                                    <span class="validation-text">Validez-vous cette déclaration d'heures
                                                        pour {{ $monthNames[$mois] }} {{ $annee }} ?</span>
                                                </div>
                                                <div class="col-12 text-center">
                                                    <button class="btn btn-success btn-custom" id="valider-btn"
                                                        type="button">Valider</button>
                                                    <button class="btn btn-danger btn-custom" id="refuser-btn"
                                                        type="button">Refuser</button>
                                                    <button class="btn btn-info btn-custom" id="enregistrer-btn"
                                ...
                                <b>
                                    <h1>{{ $pro->firstname }} {{ $pro->lastname }} - Mois de {{ $monthNames[$mois] }}
                                        {{ $annee }}</h1>
                                    <h3>Saison {{ $pro->Saison }}-{{ $pro->Saison + 1 }} : Du 1er Août
                                        {{ $pro->Saison }}
                                        au 31 Juillet {{ $pro->Saison + 1 }}</h3>
                                </b>
                                        ...
                                        @for ($day = 1; $day <= $daysInMonth; $day++)
                                            @php
                                                ...
                                                $detail_data = $declaration->details_admin
                                                    ...
                                                    : $declaration->details;
                                                $details =
                                                    isset($declaration) && array_key_exists($day - 1, $detail_data)
                                                        ? $detail_data[$day - 1]
                                                        : null;
                                            @endphp
