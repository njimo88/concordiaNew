<div class="modal fade" id="editAnimationModal" data-bs-focus="false" aria-labelledby="editAnimationModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editAnimationModalLabel">Modifier l'animation</h5>
            ...
            <div class="modal-body">
                ...
                @if($animation->updated_at && $animation->updated_by)
                    <div class="alert alert-info">
                        ...
                        <p id="modal-updater-name"></p>
                        <p><strong>Le :</strong> <span id="modal-updated-at"></span></p>
                    </div>
                @endif
                ...
                <form class="editAnimationForm" id="editAnimationForm{{ $animation->id }}" action="{{ route('gestion.animations.edit', $animation->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        <label for="animation_endtime-edit-{{ $animation->id }}" class="form-label">Date et Heure de fin</label>
                        <input 
                            type="datetime-local" 
                            class="form-control @error('animation_endtime-edit-' . $animation->id) is-invalid @enderror" 
                            id="animation_endtime-edit-{{ $animation->id }}" 
                            name="animation_endtime-edit-{{ $animation->id }}" 
                            value="{{ old('animation_endtime-edit-' . $animation->id, $animation->animation_endtime) }}" 
                            required>
                        <div class="invalid-feedback"></div>
                    </div>
