                ...
                <div class="container ">
                    ...
                    <div class="row" style="--bs-gutter-x: 0.5rem;">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select @if(auth()->user()->role < $user->role && auth()->user()->user_id !=
                                        $user->user_id)
                                        disabled
                                        @endif
                    ...
                    <div class="row" style="--bs-gutter-x: 0.5rem;">
                        <div class="col-md-4 input mt-2">
                            ...
                            @endif
                            <input @if(auth()->user()->role < $user->role && auth()->user()->user_id !=
                                $user->user_id) readonly @endif type="file" id="crt" name="crt"
                                class="form-control
                        ...
                        <div class="col-md-4 input mt-2">
                            ...
                            <input @if(auth()->user()->role < $user->role && auth()->user()->user_id !=
                                $user->user_id) readonly @endif type="date" id="crt_emission" name="crt_emission"
                        ...
                        <div class="col-sm-4 input mt-2">
                            ...
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="crt_delete" name="crt_delete"
                                    value="1" @if(auth()->user()->role < $user->role && auth()->user()->user_id
                                    !=
                                    $user->user_id) disabled @endif>
                            </div>
                        </div>
                    </div>
