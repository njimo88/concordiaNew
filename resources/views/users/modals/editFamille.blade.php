...
<div class="modal fade" style="--bs-modal-width: 70vw;" id="editFamille{{ $n_users->user_id }}" tabindex="-1" role="dialog"
        ...
        <div class="modal-content">
            <form action="{{ route('users.editFamille', $n_users->user_id) }}" method="post"
                            ...
                            <div class="card-body">
                                <div class="photo-container d-flex mb-3 gap-2 w-100">
                                    <div class="photo">
                                        <div>
                                            @if ($n_users->image)
                                                <img src="{{ asset($n_users->image) }}" width="150px"
                                                    alt="Profile Picture">
                                            @elseif ($n_users->gender == 'male')
                                                <img src="{{ asset('assets/images/user.jpg') }}" width="150px"
                                                    alt="male">
                                    ...
                                    <div class="flex-grow-1 d-flex flex-column gap-2">
                                        <div
                                            class="form-group w-100 d-flex flex-column align-items-start align-self-start">
                                            <label for="name" class="w-100">Nom</label>
                                            <input class="form-control w-85 @error('name') is-invalid @enderror"
                                ...
                                <div class="form-group d-flex align-items-center mb-2 gap-2">
                                    <div class="w-50 pe-2">
                                        ...
                                        <select class="form-select w-100" id="gender" name="gender"
                                            ...
                                            <option value="female"
                                                {{ $n_users->gender == 'female' ? 'selected' : '' }}>
                                                Femme
                                            </option>
                                        </select>
                                        @error('gender')
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group d-flex align-items-center mb-2 gap-2">
                                    ...
                                    <input class="form-control w-75 @error('email') is-invalid @enderror"
                                        type="email" id="email" name="email" value="{{ $n_users->email }}"
                                        {{ auth()->user()->role < $n_users->role && auth()->user()->user_id != $n_users->user_id ? 'readonly' : '' }} />
                                    @error('email')
                                        <div class="text-black">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group d-flex align-items-center mb-2 gap-2">
                                    <div class="w-50 pe-2">
                                        ...
                                        <input class="form-control w-100 @error('phone') is-invalid @enderror"
                                    ...
                                    <div class="w-50 pe-2">
                                        ...
                                        <select @if (auth()->user()->role < $n_users->role && auth()->user()->user_id != $n_users->user_id) disabled @endif
                                            data-style="btn-light" data-flag="true" id="country"
                                            class="w-100 selectpicker countrypicker @error('country') is-invalid
                                            @enderror"
                                            name="country" data-default="{{ $n_users->country }}"
                                ...
                                <div class="form-group d-flex align-items-center mb-2 gap-2">
                                    <div class="w-50 pe-2">
                                        ...
                                        <input class="form-control w-100 @error('zip') is-invalid @enderror"
                                    ...
                                    <div class="w-50 pe-2">
                                        ...
                                        <input class="form-control w-100 @error('city') is-invalid @enderror"
                                        ...
                                        <div class="form-group d-flex align-items-center mb-2 gap-2">
                                            ...
                                            @if ($n_users->medicalCertificate && $n_users->medicalCertificate->file_path)
                                                <i class="fas fa-file-medical" data-toggle="modal"
                                                    data-target="#imageModal{{ $n_users->user_id }}"
                                                ...
                                                <div class="w-100 pe-2">
                                                    ...
                                                    @foreach ($n_users->adhesions->groupBy('saison') as $saison => $adhesions)
                                                        ...
                                                        <h5 class="mt-3">Saison
                                                            {{ $saison }}-{{ $saison + 1 }}
                                                            @if ($hasAdhesion)
                                                                <img src="{{ asset('img/badge-membre.png') }}"
                                                                    alt="" style="width: 55px; height: 45px;">
                                                            @endif
                                                        </h5>
                                    ...
                                    <div>
                                        ...
                                        <div class="form-group d-flex align-items-center mb-2 gap-2">
                                            <div class="w-50 pe-2">
                                                ...
                                                <input @if (auth()->user()->role < $n_users->role && auth()->user()->user_id != $n_users->user_id) readonly @endif
                                                    type="date" id="crt_emission" name="crt_emission"
                                            ...
                                            {{-- <div class="w-50 pe-2">
                                                ...
                                                <input type="checkbox" class="form-check-input p-0 m-0"
                                                    style="width:25px; height:25px;" id="crt_delete"
                                                    name="crt_delete" value="1"
                                                    @if (auth()->user()->role < $n_users->role && auth()->user()->user_id != $n_users->user_id) disabled @endif>
                                            </div> --}}
                                        </div>
                                    </div>
                                    @if ($n_users->adhesions->count() >= 1)
                ...
                <div class="w-100 d-flex justify-content-center">
                    <button type="submit" class="btn-save w-auto">Sauver Profil</button>
                </div>
            </form>
        </div>
    </div>
