...
@section('content')
    ...
    <section style="background-image: url('{{ asset('/assets/images/famillee.jpeg') }}');"
                ...
                <div class="col-12 col-xl-10">
                    <div class="content py-3">
                        @foreach ($n_users as $n_users)
                            <div class="card-container">
                                <div class="upper-container">
                                    <div class="image-container">
                                        @if ($n_users->image)
                                            <img src="{{ asset($n_users->image) }}" alt="{{ $n_users->name }}"
                                                onclick="chooseProfileImage({{ $n_users->user_id }});">
                                        @elseif ($n_users->gender == 'male')
                                            <img src="{{ asset('assets\images\user.jpg') }}" alt="male"
                                                onclick="chooseProfileImage({{ $n_users->user_id }});">
                                        @elseif ($n_users->gender == 'female')
                                            <img src="{{ asset('assets\images\femaleuser.png') }}" alt="female"
                                                onclick="chooseProfileImage({{ $n_users->user_id }});">
                                        @endif
                                    </div>
                                </div>
                                <div class="lower-container">
                                    <div>
                                        ...
                                        <h6>
                                            ...
                                            @endif
                                            <img src="https://flagcdn.com/w20/{{ strtolower($n_users->nationality) }}.png"
                                    ...
                                    <div>
                                        ...
                                        <a data-toggle="modal" data-target="#editFamille{{ $n_users->user_id }}"
                            ...
                            <!-- Modal -->
                            <div class="modal fade" id="imageModal{{ $n_users->user_id }}" tabindex="-1"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            @if ($n_users->medicalCertificate && $n_users->medicalCertificate->file_path)
                                                <img src="{{ asset($n_users->medicalCertificate->file_path) }}"
                                                    class="rounded mx-auto d-block zoomed-in w-100"
                        ...
                        <div class="mt-3 pb-5 px-5   ">
                            <button data-toggle="modal" data-target="#addMember" type="button"
                                value="{{ $user->family_id }}" class="btn mr-md-2 mb-md-0 mb-2 btn-primary">Ajouter un
                                parent<i class="m-2 fa-regular fa-circle-plus"></i></button>
                            <button data-toggle="modal" data-target="#addEnfant" type="button"
                                value="{{ $user->family_id }}" class=" btn-rouge mr-md-2 mb-md-0 mb-2 btn-success">Ajouter
                                un enfant<i class="m-2 fa-regular fa-circle-plus"></i></button>
                        </div>

                        <!-- Modal parent-->
                        <div style="--bs-modal-width: 800px; !important" class="modal fade " id="addMember" tabindex="-1"
                        ...
                        <!-- Modal enfant-->
                        <div style="--bs-modal-width: 800px; !important" class="modal fade " id="addEnfant" tabindex="-1"
                            role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content ">
