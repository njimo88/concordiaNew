...
<body>
                        ...
                        <div class="col-lg-3">
                            <div class="card">
                                <div class="stat-widget-one">
                                    ...
                                    <div class="stat-icon dib"><img class="" src="{{ asset("assets/images/work.png") }}"
                                            alt="">
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        <div class="d-flex align-items-center justify-content-between"> <a href="{{ route('admin.index') }}"
                class="logo d-flex align-items-center"> <img src="{{ asset('assets/images/LogoHB.png') }}" alt=""> <span
    ...
    <aside id="sidebar" class="sidebar">
        <ul class="sidebar-nav" id="sidebar-nav">
            <li class="nav-item"> <a class="nav-link " href="{{ route('admin.index') }}"> <i class="bi bi-grid"></i>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#"><span
                        style="margin-right: 5px; color:#007b00;" class="fa fa-users fa-fw mr-2 gc-green"></span>
                    <span>Utilisateurs</span><i class="bi bi-chevron-down ms-auto"></i> </a>
                <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    @if(auth()->user()->roles->estAutoriserDeVoirMembres)<li> <a
                            href="{{route('utilisateurs.members')}}"> <i style="color: #007b00"
                                class="fa-solid fa-user"></i><span>Membres</span> </a></li>@endif
                    @if (auth()->user()->roles->estAutoriserDeVoirClickAsso)<li> <a href="{{route('users.clickasso')}}">
                            <i style="color: #007b00" class="fa-light fa-at"></i><span>ClickAsso</span> </a></li>@endif
                    ...
                    <li> <a href="{{ route('portesOuvertes') }}"> <i style="color: #007b00"
                                class="fa-sharp fa-solid fa-door-open"></i><span>Portes Ouvertes</span> </a></li>
                    @endif
                </ul>
            </li>
            @endif
            @if ( auth()->user()->roles->estAutoriserDeVoirArticles ||
            auth()->user()->roles->estAutoriserDeRedigerArticle || auth()->user()->roles->estAutoriserDeVoirCategories)
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#forms-nav" data-bs-toggle="collapse" href="#"> <i
                        style="color: #0ef9de" class="bi bi-journal-text"></i><span>Blog</span><i
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#"> <i
                        style="color: #ff0000" class="fa-solid fa-money-bill"></i><span>Paiement</span><i
                        class="bi bi-chevron-down ms-auto"></i> </a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#icons-nav" data-bs-toggle="collapse" href="#"> <i
                        style="color: #f7bac5" class="bi bi-gem"></i><span>Boutique</span><i
                        class="bi bi-chevron-down ms-auto"></i> </a>
            ...
            @if( auth()->user()->roles->estAutoriserDeVoirArticleBoutique )<li> <a href="{{ route('article') }}"><span
                        style="color: #f7bac5; margin-right:8px"
                        class="fa fa-basket-shopping fa-fw mr-1"></span><span>Article</span> </a></li>@endif
            @if( auth()->user()->roles->estAutoriserDeVoirCategorieBoutique )<li> <a
                    href="{{ route('A_Categorie') }}"><span style="color: #f7bac5; margin-right:8px"
                        class="fa fa-coins fa-fw mr-1"></span><span>Catégories</span> </a></li>@endif
            @if( auth()->user()->roles->estAutoriserDeVoirModeStrict )<li> <a href="{{ route('mode_strict') }}"><span
                        style="color: #f7bac5; margin-right:8px" class="fa-solid fa-user-ninja mr-1"></span><span>Mode
                        Strict</span> </a></li>@endif
            @if( auth()->user()->roles->estAutoriserDeVoirParametrage )<li> <a
                    href="{{ route('payment_selection') }}"><span style="color: #f7bac5; margin-right:8px"
                        class="fa fa-cog mr-1"></span><span>Paramètrage</span> </a></li>@endif
        </ul>
        </li>
        @endif
        ...
        <li class="nav-item">
            ...
            <ul id="logistics-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                @if (auth()->user()->roles->estAutoriserDeVoirPreparationLogistique)
                <li> <a href="{{ route('logistique.preparation') }}"><span style="color: #4CAF50; margin-right:8px"
                ...
                <li> <a href="{{ route('logistique.distribution') }}"><span style="color: #4CAF50; margin-right:8px"
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#charts-nav" data-bs-toggle="collapse" href="#"> <i
                    style="color: #f80000;" class="fa-regular fa-message"></i><span>Communication</span><i
                    class="bi bi-chevron-down ms-auto"></i> </a>
            <ul id="charts-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                @if (auth()->user()->roles->estAutoriserDeVoirMessages)<li> <a
                        href="{{route('index_communication')}}"><span style="color: #f80000; margin-right:8px"
                            class="fa fa-envelope fa-fw mr-1"></span><span>Envoi de mail</span> </a></li>@endif
                @if (auth()->user()->roles->estAutoriserDeVoirHistorique)<li> <a href="{{route('historique')}}"><span
                            style="color: #f80000; margin-right:8px"
                            class="fa fa-clock-rotate-left fa-fw mr-1"></span><span>Historique</span> </a></li> @endif
            </ul>
        </li>
        @endif
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#club-nav" data-bs-toggle="collapse" href="#"><span
                    style="color: #f59f00; margin-right:10px" class="fa fa-medal fa-fw mr-2 gc-orange"></span><span>Le
                    Club @php $certificatsEnAttente = \App\Models\MedicalCertificates::where('validated', 0)->count();
                    @endphp @if($certificatsEnAttente > 0) <span class="badge bg-danger"
                        style="margin-left: 5px;">{{ $certificatsEnAttente }}</span> @endif</span><i
                    class="bi bi-chevron-down ms-auto"></i> </a>
            <ul id="club-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                @if (auth()->user()->roles->estAutoriserDeVoirCours)<li> <a href="{{route('index_cours')}}"><span
                            style="color: #f59f00; margin-right:10px"
                            class="fa fa-person-running fa-fw mr-1"></span><span>Cours</span> </a></li>@endif
                <!-- @if (auth()->user()->roles->estAutoriserDeVoirProduitsClub)<li> <a
                        href="{{ route('index_produits') }}"><span style="color: #f59f00; margin-right:10px"
                            class="fa fa-box-open fa-fw mr-1"></span><span>Produits</span> </a></li>@endif
                @if (auth()->user()->roles->estAutoriserDeVoirAdhesionsClub)<li> <a
                        href="{{ route('index_adhesions') }}"><span style="color: #f59f00; margin-right:10px"
                            class="fa fa-users fa-fw mr-1"></span><span>Adhésions</span> </a></li>@endif -->
                @if (auth()->user()->roles->estAutoriserDeVoirStatsExports)<li> <a
                        href="{{ route('StatsExports') }}"><span style="color: #f59f00; margin-right:10px"
                            class="fa fa-chart-line fa-fw mr-1"></span><span>Stats-Exports</span> </a></li>@endif
                @if (auth()->user()->roles->estAutoriserDeVoirValiderCertificats)<li> <a
                        href="{{ route('validationCertificats') }}"><span style="color: #f59f00; margin-right:10px"
                            class="fa fa-stamp fa-fw mr-1"></span><span>Valider Certificats @php $certificatsEnAttente =
                            \App\Models\MedicalCertificates::where('validated', 0)->count(); @endphp
                            @if($certificatsEnAttente > 0) <span class="badge bg-danger"
                                style="margin-left: 5px;">{{ $certificatsEnAttente }}</span> @endif</span> </a></li>
                @endif
                @if (auth()->user()->roles->estAutoriserDeVoirHistroriqueClub)<li> <a
                        href="{{route('history_index')}}"><span style="color: #f59f00; margin-right:10px"
                            class="fa-sharp fa-solid fa-clock-rotate-left"></span><span>Historique</span> </a></li>
                @endif
            </ul>
        </li>
        @endif
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#anim-nav" data-bs-toggle="collapse" href="#">
                <span style="color: #17a2b8; margin-right:10px" class="fa fa-cogs fa-fw mr-2 gc-yellow"></span>
            ...
            <ul id="anim-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                <li>
                    <a href="{{ route('gestion.animations') }}">
                        <span style="color: #17a2b8; margin-right:10px" class="fa fa-calendar-check fa-fw mr-1"></span>
                        <span>Séances</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('gestion.categories.animations') }}">
                        <span style="color: #17a2b8; margin-right:10px" class="fa fa-list-ol fa-fw mr-1"></span>
        ...
        auth()->user()->roles->estAutoriserDeVoirParametresGeneraux || auth()->user()->roles->estAutoriserDeVoirSalles
        || auth()->user()->roles->estAutoriserDeVoirMessageGeneral )
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#para-nav" data-bs-toggle="collapse" href="#"><span
                    style="color: #f5f503; margin-right:10px"
            ...
            <ul id="para-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                @if (auth()->user()->roles->estAutoriserDeVoirGestionDesDroits)<li> <a
                        href="{{  route('index_roles') }}"><span style="color: #f5f503; margin-right:10px"
                            class="fa fa-user-check fa-fw mr-1"></span><span>Gestion des droits</span> </a></li>@endif
                @if (auth()->user()->roles->estAutoriserDeVoirParametresGeneraux)<li> <a
                        href="{{ route('parametres') }}"><span style="color: #f5f503; margin-right:10px"
                            class="fa fa-map-location-dot fa-fw mr-1"></span><span>Paramètres</span> </a></li>@endif
                @if (auth()->user()->roles->estAutoriserDeVoirSalles)<li> <a href="{{ route('index_salle') }}"><span
                            style="color: #f5f503; margin-right:10px"
                            class="fa fa-map-location-dot fa-fw mr-1"></span><span>Salles</span> </a></li>@endif
                @if (auth()->user()->roles->estAutoriserDeVoirMessageGeneral) <li> <a
                        href="{{ route('message.general') }}"><i style="color: #f5f503;"
                            class="fa-regular fa-message"></i></span><span>Message Général</span> </a></li>@endif
                @if (auth()->user()->roles->estAutoriserDeVoirFichiers) <li> <a href="{{ route('server.browser') }}"><i
                            style="color: #f5f503;" class="fa-regular fa-file"></i></span><span>Fichiers Serveur</span>
                    </a></li>@endif
                @if (auth()->user()->roles->estAutoriserDeVoirMessageMaintenance) <li> <a
                        href="{{ route('message.maintenance.see') }}"><i style="color: #f5f503;"
                            class="fa-regular fa-message"></i></span><span>Message de maintenance</span> </a></li>@endif
            </ul>
        </li>
        @endif
        </ul>
    ...
    <script src="//g.tutorialjinni.com/mojoaxel/bootstrap-select-country/dist/js/bootstrap-select-country.min.js">
    </script>
