            ...
            <div class="col-12 col-lg-10">
                <div class="row row-infos">
                    <div class="col-12 col-md-5 pt-1">
                        <div class="content">
                            <img src="{{ asset('assets\images\LogoHB.png') }}" alt="Logo Gym Concordia"
                                class="img-fluid footer-logo">
                            <hr>
                            <table class="alignleft" style="width: 100%; border-collapse: collapse;">
                                <tbody>
                                    <tr style="height: 30px;">
                                        <td style="width: 16.2162%;"><img decoding="async" loading="lazy"
                                                class="aligncenter wp-image-267"
                                                src="https://www.concordia.fr/wp-content/uploads/2022/02/phone.png"
                                                alt="" width="26" height="26"></td>
                                        <td style="width: 83.5351%;"><span style="color: #482683;"><a
                                                    style="color: #482683;" href="tel:0805659999">0 805 65 99
                                                    99</a></span></td>
                                    </tr>
                                    <tr style="height: 30px;">
                    ...
                    <div class="col-12 col-md-7">
                        ...
                        <div class="d-flex flex-wrap justify-content-center justify-content-md-end pt-3">
                            <a href="https://www.facebook.com/GymConcordia" target="_blank" style="color: #482683;"
                                class="d-block m-2"><i class="bi bi-facebook"></i></a>
                            <a href="https://www.instagram.com/gym_concordia" target="_blank" style="color: #482683;"
                                class="d-block m-2"><i class="bi bi-instagram"></i></a>
                            <a href="https://www.youtube.com/user/GymConcordia" target="_blank"style="color: #482683;"
                                class="d-block m-2"><i class="bi bi-youtube"></i></a>
                            <a href="https://www.tiktok.com/discover/gym-concordia-schiltigheim?lang=fr"style="color: #482683;"
                                target="_blank" class="d-block m-2"><i class="bi bi-tiktok"></i></a>
                        </div>
                        <div class="content text-end text-md-end">
                            <p><span style="color: #482683;">Réalisation : <a style="color: #482683;" target="_blank"
                                        rel="noopener">Forma-SIS - N.DJILLY</a></span><br>
                                <span style="color: #482683;"><a style="color: #482683;"
                                        href="{{ route('index_mentions_legales') }}" target="_blank">Mentions
                                        légales</a> | <a style="color: #482683;" href="{{ route('index_politique') }}"
