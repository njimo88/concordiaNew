d3 = (function () {
    ...
    function xt() {
        var n = Mt(),
            t = _t() - n
        t > 24
            ? (isFinite(t) && (clearTimeout(Ja), (Ja = setTimeout(xt, t))),
              (Wa = 0))
            : ((Wa = 1), Ka(xt))
    }
    function Mt() {
                ...
                y = {
                    ...
                    polygonEnd: function () {
                        ...
                        g.length
                            ? Vt(g, Gt, n, e, i)
                            : n &&
                              (i.lineStart(), e(null, null, 1, i), i.lineEnd()),
                            i.polygonEnd(),
                            (g = p = null)
                    },
                    sphere: function () {
        ...
        return function (a) {
            function c(n) {
                for (var t = 0, e = m.length, r = n[1], u = 0; e > u; ++u)
                    for (
                        var i, o = 1, a = m[u], c = a.length, l = a[0];
                        c > o;
                        ++o
                    )
                        (i = a[o]),
    ...
    function Le(n, t) {
        ...
        return function (u, i, o, a) {
            ...
            for (var s, l = u; o > 0 ? l > i : i > l; l -= c)
                a.point(
                    (s = Ut([e, -r * Math.cos(l), -r * Math.sin(l)]))[0],
                    s[1],
                )
        }
    }
    ...
    function _r(n, t) {
        var e,
            ...
            i = n.sort(br).pop()
        for (
            Vc = [], Xc = new Array(n.length), $c = new dr(), Wc = new dr();
            ;

        )
            if (
                ((u = Bc), i && (!u || i.y < u.y || (i.y === u.y && i.x < u.x)))
            )
                (i.x !== e || i.y !== r) &&
        ...
        for (
            ...
            if (((o = l[r]), o.x == e[0])) {
                if (o.i)
                    if (null == s[o.i + 1])
                        for (
                            s[o.i - 1] += o.x, s.splice(o.i, 1), u = r + 1;
                            i > u;
                            ++u
                        )
                            l[u].i--
    ...
    function Zr(n, t) {
        ...
        return (
            ...
            function (r) {
                return (
                    1 + n * Math.pow(2, -10 * r) * Math.sin(((r - e) * Ea) / t)
                )
            }
        )
    }
    ...
    function mi(n, t) {
        function e(e) {
            return o[
                ((i.get(e) || ('range' === t.t && i.set(e, n.push(e)))) - 1) %
                    o.length
            ]
        }
        function r(t, e) {
    ...
    function qi(n, t) {
        return n.length < 4
            ? Ai(n)
            : n[1] + Di(n.slice(1, n.length - 1), Pi(n, t))
    }
    function zi(n, t) {
        return n.length < 3
            ? Ai(n)
            : n[0] +
                  Di(
                      (n.push(n[0]), n),
                      Pi([n[n.length - 2]].concat(n, [n[1]]), t),
                  )
    }
    function Ri(n, t) {
    ...
    function Vi(n) {
        for (
            var t, e, r, u, i = [], o = Zi(n), a = -1, c = n.length - 1;
            ++a < c;
    ...
    ;($o.bisectLeft = oa.left),
        ...
        ($o.zip = function () {
            ...
            for (
                var n = -1, e = $o.min(arguments, t), r = new Array(e);
                ++n < e;
        ...
        (ma.selectAll = function (n) {
            ...
            for (var u = -1, i = this.length; ++u < i; )
                for (var o = this[u], a = -1, c = o.length; ++a < c; )
                    (e = o[a]) &&
                        (r.push((t = Wo(n.call(e, e.__data__, a, u)))),
                        (t.parentNode = e))
            return p(r)
        })
    var ya = {
    ...
    ;($o.interpolateZoom = function (n, t) {
        ...
        ($o.behavior.zoom = function () {
            ...
            function l() {
                ...
                function e() {
                    for (
                        var t = $o.event.changedTouches, e = 0, i = t.length;
                        i > e;
                        ++e
                    )
    ...
    ;($o.geo.path = function () {
        ...
        ($o.geo.rotation = function (n) {
            function t(t) {
                return (
                    (t = n(t[0] * La, t[1] * La)), (t[0] *= Ta), (t[1] *= Ta), t
                )
            }
            return (
                (n = Ee(
                ...
                (a.tick = function () {
                    ...
                    for (e = 0; b > e; ++e)
                        (a = m[e]),
                            ...
                            (v = x * x + M * M) &&
                                ((v =
                                    (r * i[e] * ((v = Math.sqrt(v)) - u[e])) /
                                    v),
                                (x *= v),
                                (M *= v),
                                (h.x -=
                                    x * (y = f.weight / (h.weight + f.weight))),
                                (h.y -= M * y),
                                (f.x += x * (y = 1 - y)),
                                (f.y += M * y))
                    if (
                        (y = r * p) &&
                        ((x = s[0] / 2), (M = s[1] / 2), (e = -1), y)
                    )
                        for (; ++e < _; )
                            (a = d[e]),
                                (a.x += (x - a.x) * y),
                    ...
                    if (g)
                        for (
                            fu((t = $o.geom.quadtree(d)), r, o), e = -1;
                            ++e < _;
            ...
            function n(n, i) {
                ...
                function c(n, t, r) {
                    if (t) {
                        ...
                        a &&
                            !Lu(o) &&
                            ((o._tree.thread = a), (o._tree.mod += f - l)),
                            i &&
                                !Nu(c) &&
                                ((c._tree.thread = i),
                                (c._tree.mod += s - h),
        ...
        ($o.layout.pack = function () {
            function n(n, i) {
                ...
                if (
                    ...
                    var f =
                        (r * (t ? 1 : Math.max((2 * a.r) / c, (2 * a.r) / s))) /
                        2
                    Du(a, function (n) {
                        n.r += f
                    }),
                ...
                if (t == e.dx) {
                    for ((r || l > e.dy) && (l = e.dy); ++i < o; )
                        (u = n[i]),
                            ...
                            (u.dy = l),
                            (a += u.dx =
                                Math.min(e.x + e.dx - a, l ? c(u.area / l) : 0))
                    ;(u.z = !0),
                        (u.dx += e.x + e.dx - a),
                        (e.y += l),
                        (e.dy -= l)
                    ...
                    for ((r || l > e.dx) && (l = e.dx); ++i < o; )
                        (u = n[i]),
                            ...
                            (u.dx = l),
                            (s += u.dy =
                                Math.min(e.y + e.dy - s, l ? c(u.area / l) : 0))
                    ;(u.z = !1),
                        (u.dy += e.y + e.dy - s),
                        (e.x += l),
                        (e.dx -= l)
    ...
    ;(Cs.call = ma.call),
        ...
        (Cs.delay = function (n) {
            ...
            return C(
                ...
                'function' == typeof n
                    ? function (e, r, u) {
                          e.__transition__[t].delay = +n.call(
                              e,
                              e.__data__,
                              r,
                              u,
        ...
        (Cs.each = function (n, t) {
            ...
            if (arguments.length < 2) {
                ...
                C(this, function (r) {
                    ...
                    ;(u.event || (u.event = $o.dispatch('start', 'end'))).on(
                        n,
                        t,
                    )
                })
    ...
    $o.svg.brush = function () {
        ...
        return (
            ...
            (n.clear = function () {
                return (
                    n.empty() || ((l = [0, 0]), (h = [0, 0]), (i = o = null)), n
                )
            }),
            (n.empty = function () {
        ...
        Ps.forEach(function (n, t) {
            ...
            var e = (Rs[n] = co(
                ...
                function (n) {
                    ...
                    return (
                        Math.floor((Rs.dayOfYear(n) + ((e + t) % 7)) / 7) -
                        (e !== t)
                    )
                },
            ))
