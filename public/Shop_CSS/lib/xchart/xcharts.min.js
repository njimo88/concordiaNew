...
;(function () {
                ...
                function (n, t, r, e) {
                    ...
                    return (
                        A(u, function (r, e) {
                            ;(t
                                ? e && a[a.length - 1] === r
                                : w.contains(a, r)) || (a.push(r), i.push(n[e]))
                        }),
                        i
                    )
                }),
            ...
            (w.mixin = function (n) {
                A(w.functions(n), function (t) {
                    ...
                    w.prototype[t] = function () {
                        var n = [this._wrapped]
                        return (
                            a.apply(n, arguments), z.call(this, r.apply(w, n))
                        )
                    }
                })
            })
    ...
    function getInsertionPoint(zIndex) {
        return _.chain(_.range(zIndex, 10))
            .reverse()
            .map(function (z) {
    ...
    function _getExtents(options, data, xType, yType) {
        var extents,
            nData = _.chain(data).pluck('data').flatten().value()
        extents = {
    ...
    ;(function () {
        ...
        function enter(self, storage, className, data, callbacks) {
            var barGroups,
                ...
                yZero = self.yZero
            barGroups = self._g
                .selectAll(selector + className)
                .data(data, function (d) {
                    return d.className
                })
            barGroups
                .enter()
                .insert('g', insertBefore)
            ...
            bars = barGroups.selectAll('rect').data(
                function (d) {
                    return d.data
                },
                function (d) {
    ...
    ;(function () {
        ...
        function enter(self, storage, className, data, callbacks) {
            ...
            circles = storage.lineContainers.selectAll('circle').data(
                function (d) {
                    return d.data
                },
                function (d) {
    ...
    _.defaults(xChart.prototype, {
        ...
        _drawSvg: function () {
            ...
            self._height =
                ...
                options.axisPaddingTop -
                options.axisPaddingBottom
            self._width =
                width -
                options.paddingLeft -
                options.paddingRight -
                options.axisPaddingLeft -
                options.axisPaddingRight
        },
        ...
        _drawAxes: function () {
            ...
            zLinePath
                ...
                .attr(
                    'x2',
                    self._width + o.axisPaddingLeft + o.axisPaddingRight,
                )
                .attr('y1', self.yZero)
                .attr('y2', self.yZero)
            zLinePath
        ...
        _draw: function () {
            ...
            self._noData =
                _.flatten(
                    _.pluck(self._mainData, 'data').concat(
                        _.pluck(self._compData, 'data'),
                    ),
                ).length === 0
            self._updateScale()
            self._drawAxes()
