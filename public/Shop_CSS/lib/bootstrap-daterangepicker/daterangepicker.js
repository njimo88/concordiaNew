        ...
        enterDate: function (e) {
            ...
            if (cal.hasClass('left')) {
                this.container
                    .find('input[name=daterangepicker_start]')
                    .val(
                        this.leftCalendar.calendar[row][col].toString(
                            this.format,
                        ),
                    )
            } else {
                this.container
                    .find('input[name=daterangepicker_end]')
                    .val(
                        this.rightCalendar.calendar[row][col].toString(
                            this.format,
                        ),
                    )
            }
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate) {
            ...
            for (var row = 0; row < 6; row++) {
                ...
                if (this.showWeekNumbers)
                    html +=
                        '<td class="week">' +
                        calendar[row][0].getWeek() +
                        '</td>'

                for (var col = 0; col < 7; col++) {
                    var cname = 'available '
                    cname +=
                        calendar[row][col].getMonth() ==
                        calendar[1][1].getMonth()
                            ? ''
                            : 'off'
