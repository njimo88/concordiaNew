...
$.fn.zabuto_calendar = function (options) {
    ...
    this.each(function () {
        ...
        function drawCalendar() {
            ...
            var tableClassHtml =
                $calendarElement.data('cellBorder') === true
                    ? ' table-bordered'
                    : ''
        ...
        function appendMonthHeader($calendarElement, $tableObj, year, month) {
            ...
            var $prevMonthNav = $(
                '<div class="calendar-month-navigation"></div>',
            )
            ...
            if (prevIsValid !== false) {
                ...
                if (
                    typeof $calendarElement.data('actionNavFunction') ===
                    'function'
                ) {
                    $prevMonthNav.click(
                        $calendarElement.data('actionNavFunction'),
                    )
                }
            ...
            if (typeof nextIsValid === 'number' || nextIsValid === false) {
                nextIsValid = checkMonthLimit(
                    $calendarElement.data('showNext'),
                    false,
                )
            }
            ...
            for (var wk = 0; wk < weeksInMonth; wk++) {
                ...
                for (var dow = 0; dow < 7; dow++) {
                    if (dow < firstDow || currDayOfMonth > lastDayinMonth) {
                        ...
                        if (
                            typeof $calendarElement.data('actionFunction') ===
                            'function'
                        ) {
