                ...
                (d.prototype.setData = function (c, d) {
                    ...
                    if (
                        ...
                        if (this.options.parseTime)
                            for (
                                x = this.options.events, v = 0, w = x.length;
                                w > v;
                                v++
                            )
                                (e = x[v]),
                        ...
                        ((i = this.options.axes) === !0 ||
                            ...
                            (b = function () {
                                ...
                                for (
                                    ...
                                    d.push(
                                        this.measureText(this.data[e].label, a)
                                            .height,
                                    )
                                return d
                            }.call(this)),
        ...
        (b.Line = (function (c) {
            ...
            return (
                ...
                (d.prototype.hoverContentForRow = function (b) {
                    ...
                    for (
                        e = this.data[b],
                            c = a("<div class='morris-hover-row-label'>").text(
                                e.label,
                            ),
                            c = c.prop('outerHTML'),
                            i = e.y,
                ...
                (d.prototype.drawSeries = function () {
                    ...
                    for (
                        ...
                        f.push(
                            this.hasToShow(a) ? this._drawPointFor(a) : void 0,
                        )
                    return f
                }),
                    ...
                    return (
                        ...
                        this.options.horizontal
                            ? ((f = this.left + 0.5 * this.width),
                              (g =
                                  this.top +
                                  ((b + 0.5) * this.height) / this.data.length),
                              [c, f, g, !0])
                            : ((f =
                                  this.left +
                                  ((b + 0.5) * this.width) / this.data.length),
                              [c, f])
                    )
                }),
                (d.prototype.drawXAxisLabel = function (a, b, c) {
