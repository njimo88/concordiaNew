    ...
    $.extend(Datepicker.prototype, {
        ...
        _doKeyPress: function (e) {
            ...
            if ($.datepicker._get(t, 'constrainInput')) {
                ...
                return (
                    e.ctrlKey || e.metaKey || r < ' ' || !n || n.indexOf(r) > -1
                )
            }
        },
        _doKeyUp: function (e) {
            ...
            var i =
                ...
                v = function (e, n, r) {
                    ...
                    $.each(i, function (e, n) {
                        var r = n[1]
                        if (
                            t.substr(g, r.length).toLowerCase() ==
                            r.toLowerCase()
                        )
                ...
                var e = {
                    ...
                    selectMonth: function () {
                        return (
                            window[
                                'DP_jQuery_' + dpuuid
                            ].datepicker._selectMonthYear(n, this, 'M'),
                            !1
                        )
                    },
                    selectYear: function () {
                        return (
                            window[
                                'DP_jQuery_' + dpuuid
                            ].datepicker._selectMonthYear(n, this, 'Y'),
                            !1
                        )
                    },
                }
                        ...
                        (this._clickOffset = f
                            ...
                            : {
                                  ...
                                  top:
                                      ...
                                      a.top -
                                      s.height() / 2 -
                                      (parseInt(s.css('borderTopWidth'), 10) ||
                                          0) -
                                      (parseInt(
            ...
            this.options.values && this.options.values.length
                ? this.handles.each(function (r) {
                      ;(n =
                          ...
                          100),
                          (l[
                              a.orientation === 'horizontal' ? 'left' : 'bottom'
                          ] = n + '%'),
                          e(this)
                              .stop(1, 1)
                  ...
                  this.panels
                      .each(function () {
                          e(this).height(
                              Math.max(
                                  0,
                                  n - e(this).innerHeight() + e(this).height(),
                              ),
                          )
                      })
                      .css('overflow', 'auto'))
                ...
                add: function (n, r, i) {
                    ...
                    return (
                        ...
                        o
                            ...
                            .hide(),
                        s
                            ? a.appendTo(this.tablist)
                            : a.insertBefore(this.tabs[i]),
