;(function (editors, elFinder) {
    if (typeof define === 'function' && define.amd) {
        ...
        var optEditors =
            elFinder.prototype._options.commandsOptions.edit.editors
        elFinder.prototype._options.commandsOptions.edit.editors =
            optEditors.concat(editors(elFinder))
    }
})(function (elFinder) {
    'use strict'
    var apps = {},
                ...
                var canvas = document.createElement('canvas'),
                    ...
                    conv = function () {
                        var url = canvas.toDataURL(toMime),
                            ...
                            m
                        if (
                            (m = url.match(/^data:([a-z0-9]+\/[a-z0-9.+-]+)/i))
                        ) {
                            mime = m[1]
                        } else {
                            mime = ''
        ...
        initImgTag = function (id, file, content, fm) {
            var node = $(this)
                ...
                spnr = $(
                    '<div class="elfinder-edit-spinner elfinder-edit-image"></div>',
                )
                    .html(
                        '<span class="elfinder-spinner-text">' +
                            fm.i18n('ntfloadimg') +
                            '</span><span class="elfinder-spinner"></span>',
                    )
                    .hide()
                    .appendTo(this),
                setup = function () {
    ...
    return [
        {
            ...
            load: function (base) {
                    ...
                    init = function (editor) {
                        var $base = $(base),
                            ...
                            tmpDiv = [
                                ...
                                $(
                                    '<div class="tui-image-editor-controls"></div>',
                                ).appendTo(tmpContainer),
                            ],
                        ...
                        setTimeout(function () {
                            ...
                            if (quty) {
                                quty.trigger('change')
                                iEditor.on(
                                    'redoStackChanged undoStackChanged',
                                    function () {
                                        quty.trigger('change')
                                    },
                                )
                            ...
                            tuiZoomCtrls = $base.find(
                                '.tie-btn-zoomIn,.tie-btn-zoomOut,.tie-btn-hand',
                            )
                            // show initial scale
                            zoom(null)
                        }, 100)
                        ...
                        $base
                            .find('.tui-colorpicker-palette-container')
                            .on(
                                'click',
                                '.tui-colorpicker-palette-preview',
                                function () {
                                    $(this)
                                        .closest('.color-picker-control')
                                        .height('auto')
                                        .find(
                        ...
                        $base.on('click', function () {
                            $base
                                .find('.tui-colorpicker-slider-container')
                                .hide()
                        })
                    },
                    loader
                ...
                if (!self.confObj.editor) {
                    ...
                    fm.loadCss([
                        cdns.tui +
                            '/tui-color-picker/latest/tui-color-picker.css',
                        cdns.tui +
                            '/tui-image-editor/' +
                            ver +
        ...
        },
        {
            ...
            info: {
                ...
                canMakeEmpty: [
                    ...
                    'image/x-ms-bmp',
                    'image/tiff',
                    /*'image/x-adobe-dng',*/ 'image/webp',
                    /*'image/x-xcf',*/ 'image/vnd.adobe.photoshop',
                    'application/pdf',
                    'image/x-portable-pixmap',
                    'image/x-sketch',
                    'image/x-icon',
                    'image/vnd-ms.dds' /*'application/x-msmetafile'*/,
                ],
                integrate: {
                    title: 'Photopea',
            ...
            init: function (id, file, dum, fm) {
                var orig = 'https://www.photopea.com',
                    ...
                    spnr = $(
                        '<div class="elfinder-edit-spinner elfinder-edit-photopea"></div>',
                    )
                        .html(
                            '<span class="elfinder-spinner-text">' +
                                fm.i18n('nowLoading') +
                ...
                if (!confObj.liveMsg) {
                    confObj.liveMsg = function (ifm, spnr, file) {
                        ...
                        this.load = function () {
                            return fm
                                .getContents(file.hash, 'arraybuffer')
                                .done(function (d) {
                                    data = d
                                })
                        }
            ...
            getContent: function () {
                return this.editor.liveMsg
                    ? this.editor.liveMsg.getContent()
                    : void 0
            },
            ...
            load: function (base) {
                var self = this,
                    ...
                    init = function (onload) {
                        ...
                        if (!container.length) {
                            container = $(
                                '<div id="elfinder-pixo-container" class="ui-front"></div>',
                            )
                                .css({
                                    position: 'fixed',
                                    top: 0,
        ...
        },
        {
            ...
            load: function (textarea) {
                ...
                if (!self.confObj.loader) {
                    ...
                    if (useRequire) {
                        require([cdn + '/simplemde.min.js'], function (
                            SimpleMDE,
                        ) {
        ...
        },
        {
            ...
            load: function (textarea) {
                        ...
                        opts = {
                            ...
                            on: {
                                instanceReady: function (e) {
                                    ...
                                    dlg.one(
                                        'beforedommove.' + fm.namespace,
                                        function () {
                                            editor.destroy()
                                        },
                                    ).one(
                                        'dommove.' + fm.namespace,
                                        function () {
                                            self.load(textarea).done(
                                                function (editor) {
                ...
                if (!self.confObj.loader) {
                    ...
                    $.getScript(
                        fm.options.cdns.ckeditor + '/ckeditor.js',
                        function () {
                            self.confObj.loader.resolve()
                        },
                    )
                ...
                if (
                    ...
                    if (opts.extraOptions) {
                        ...
                        if (opts.extraOptions.ckeditor5Mode) {
                            confObj.ckeditor5Mode =
                                opts.extraOptions.ckeditor5Mode
                        }
                        confObj.ckeOpts = Object.assign(
                            {},
                            ...
                            .then(function (editor) {
                                ...
                                if (ckf) {
                                    ...
                                    insertImages = function (urls) {
                                        var imgCmd =
                                            editor.commands.get('imageUpload')
                                        if (!imgCmd.isEnabled) {
                                            var ntf =
                                                    editor.plugins.get(
                                                        'Notification',
                                ...
                                fileRepo.createUploadAdapter = function (
                                    loader,
                                ) {
                        ...
                        this.upload = function () {
                            return new Promise(function (resolve, reject) {
                                if (
                                    ...
                                    (loader.file &&
                                        typeof loader.file.then === 'function')
                                ) {
                        ...
                        textarea._setHeight = function (height) {
                            if (tVer < 5) {
                                var base = $(this).parent(),
                                    ...
                                    ctrH = 0,
                                    areaH
                                base.find('.mce-container-body:first')
                                    .children('.mce-top-part,.mce-statusbar')
                                    .each(function () {
                                        ctrH += $(this).outerHeight(true)
                                    })
                                areaH = h - ctrH - delta
                                base.find('.mce-edit-area iframe:first').height(
                                    areaH,
                                )
                            }
                        }
        ...
        },
        {
            ...
            init: function (id, file, dum, fm) {
                var ta = this,
                    ...
                    spnr = $(
                        '<div class="elfinder-edit-spinner elfinder-edit-zohoeditor"></div>',
                    )
                        .html(
                            '<span class="elfinder-spinner-text">' +
                                fm.i18n('nowLoading') +
        ...
        },
        {
            ...
            init: function (id, file, dum, fm) {
                var ta = this,
                        ...
                        dfdInit.done(function (data) {
                            ...
                            if (confObj.api) {
                                ...
                                if (!confObj.conversions[cat]) {
                                    dfd = $.getJSON(
                                        'https://api2.online-convert.com/conversions' +
                                            type,
                                    )
                                } else {
                                    dfd = $.Deferred().resolve(
                                        confObj.conversions[cat],
                                    )
                                }
                                dfd.done(function (d) {
                                    ...
                                    $.each(d, function (i, o) {
                                        btns[set.useTabs ? 'children' : 'find'](
                                            '.onlineconvert-category-' +
                                                o.category,
                                        )
                                            .children(
                                                '.onlineconvert-' + o.target,
                                            )
                    ...
                    btns = (function () {
                        var btns = $('<div></div>')
                                .on('click', 'button', function () {
                                    var b = $(this),
                                        ...
                                        cat = b
                                            .closest('.onlineconvert-category')
                                            .data('cname'),
                                        con = b.data('conv')
                                    if (confObj.api === true) {
                                        api({
                            ...
                            oform = function (n, o) {
                                ...
                                f.append(
                                    $('<span></span>').text(fm.i18n(n) + ' : '),
                                )
                                if (o.type === 'boolean') {
                                    if (
                                        o['default'] ||
                                        (nozip =
                                            n === 'allow_multiple_outputs' &&
                                            !allowZip)
                                    ) {
                                        checked = ' checked'
                                        if (nozip) {
                            ...
                            makeOption = function (o) {
                                var elm = this,
                                    b = $(
                                        '<span class="elfinder-button-icon elfinder-button-icon-preference"></span>',
                                    ).on('click', function () {
                                        f.toggle()
                                    }),
                                    f = $(
                                        '<div class="elfinder-edit-onlinconvert-options"></div>',
                                    ).hide()
                                if (o.options) {
                        ...
                        $.each(set.conv, function (t, c) {
                            var cname = t.toLowerCase(),
                                id =
                                    'elfinder-edit-onlineconvert-' + cname + ts,
                                type = $(
                                    '<div id="' +
                                        id +
                            ...
                            $.each(set.conv, function (t) {
                                ...
                                btns.append(
                                    $(
                                        ...
                                        .append($('<legend></legend>').text(t))
                                        .append(
                                            btns.children(
                                                '.onlineconvert-category-' + tl,
                                            ),
                                        ),
                                )
                            })
                    ...
                    spnr = $(
                        '<div class="elfinder-edit-spinner elfinder-edit-onlineconvert"></div>',
                    )
                        .hide()
                        .html(
                            '<span class="elfinder-spinner-text">' +
                    ...
                    prog = $(
                        '<div class="elfinder-quicklook-info-progress"></div>',
                    ).appendTo(spnr),
                    _url = null,
                    url = function () {
                        var onetime
                ...
                if (set.useTabs) {
                    ...
                    select
                        ...
                        .scrollTop(
                            btns
                                .children('.onlineconvert-fieldset-' + mode)
                                .offset().top,
                        )
                }
            },
