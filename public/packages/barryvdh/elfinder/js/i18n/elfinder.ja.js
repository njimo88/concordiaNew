...
;(function (root, factory) {
    ...
    elFinder.prototype.i18.ja = {
        ...
        messages: {
            ...
            errMkOutLink:
                'ボリュームルート外へのリンクを作成することはできません。', // from v2.1 added 03.10.2015
            ...
            emptyFolderDrop:
                '空のフォルダ\\Aアイテムを追加するにはここへドロップ', // from v2.1.6 added 30.12.2015
            emptyFolderLTap:
            ...
            reflectOnImmediate:
                '全ての変更は、直ちにアーカイブに反映されます。', // from v2.1.33 added 2.3.2018
            reflectOnUnmount:
