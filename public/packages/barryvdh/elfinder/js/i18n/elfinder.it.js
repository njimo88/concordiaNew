...
;(function (root, factory) {
    ...
    elFinder.prototype.i18.it = {
        ...
        messages: {
            ...
            errNode:
                "elFinder necessita dell'elemento DOM per essere inizializzato.",
            ...
            errUploadTemp:
                "Impossibile creare il file temporaneo per l'upload.", // from v2.1 added 26.09.2015
            errNotReplace:
            ...
            errNoArchive:
                'Il file non è un archivio o contiene file non supportati.',
            ...
            errFtpDownloadFile:
                'Impossibile scaricare il file tramite FTP: "$1"',
            errFtpUploadFile: 'Impossibile caricare il file tramite FTP: "$1"',
            errFtpMkdir:
                'Impossibile creare la cartella remota tramite FTP: "$1"',
            ...
            errFolderUpload:
                'Per uploadare l0intera cartella usare Google Chrome.', // from v2.1 added 26.6.2015
            errSearchTimeout:
            ...
            confirmRest:
                "Rimpiazza l'oggetto esistente con quello nel cestino?", // fromv2.1.24 added 5.5.2017
            confirmConvUTF8:
            ...
            incSearchOnly:
                'La ricerca incrementale è solo dalla vista corrente.', // from v2.1.13 added 6.30.2016
            ...
            infoItems:
                'Informazioni (pannello di informazioni sulla selezione)', // from v2.1.38 added 28.3.2018
