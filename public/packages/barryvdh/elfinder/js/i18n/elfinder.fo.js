...
;(function (root, factory) {
    ...
    elFinder.prototype.i18.fo = {
        ...
        messages: {
            ...
            errLocked:
                '"$1" er løst og kann ikki umdoybast, flytast ella strikast.',
            ...
            errUploadTemp:
                'Ikki ført fyri at gera fyribils fílu fyri innlegging.', // from v2.1 added 26.09.2015
            errNotReplace:
            ...
            errNotUTF8Content:
                'Fílan "$1" er ikki í UTF-8 og kann ikki vera rættað.', // added 9.11.2011
            ...
            errCreatingTempDir:
                'Ikki ført fyri at stovna fyribils fíluskrá: "$1"',
            errFtpDownloadFile:
                'Ikki ført fyri at taka fílu niður frá FTP: "$1"',
            ...
            errFolderUpload:
                'Royn Google Chrome, um tú ynskir at leggja mappu innn.', // from v2.1 added 26.6.2015
