...
;(function (root, factory) {
    ...
    elFinder.prototype.i18.tr = {
        translator:
            'I.Taskinoglu & A.Kaya &lt;alikaya@armsyazilim.com&gt;, Abdullah ELEN &lt;abdullahelen@msn.com&gt;, Osman KAYAN &lt;osmnkayan@gmail.com&gt;, alikayan95@gmail.com, Cengiz AKCAN cengiz@vobo.company',
        language: 'Türkçe',
        direction: 'ltr',
        ...
        messages: {
            ...
            errSessionExpires:
                'Uzun süre işlem yapılmadığından oturumunuz sonlandı.',
            ...
            errExtractExec:
                '"$1" Dosyaları arşivden çıkartılırken hata oluştu.',
            ...
            confirmTrash:
                'Öğeleri çöp kutusuna taşımak istediğinizden emin misiniz?', //from v2.1.24 added 29.4.2017
            ...
            autoFocusDialog:
                'Fare ile üzerine gelince diyalog öğesi odaklansın', // from v2.1.30 added 2.11.2017
            ...
            reflectOnImmediate:
                'Tüm değişiklikler hemen arşive yansıtılacaktır.', // from v2.1.33 added 2.3.2018
            reflectOnUnmount:
            ...
            editorConvNoApi:
                'API ile dönüşüm şu anda mevcut olmadığından, lütfen web sitesinde dönüştürün.', //from v2.1.40 added 8.7.2018
            editorConvNeedUpload:
                "Dönüştürmeden sonra, dönüştürülen dosyayı kaydetmek için öğe URL'si veya indirilen bir dosya ile karşıya yüklemeniz gerekir.", //from v2.1.40 added 8.7.2018
            convertOn: ' $1 site çevrildi', // from v2.1.40 added 10.7.2018
            integrations: 'Entegrasyonlar', // from v2.1.40 added 11.7.2018
            integrationWith:
                'Bu elFinder aşağıdaki harici hizmetlere entegre edilmiştir. Lütfen kullanmadan önce kullanım koşullarını, gizlilik politikasını vb. Kontrol edin.', // from v2.1.40 added 11.7.2018
            ...
            exportToSave:
                "Bu öğe kaydedilemez. Düzenlemeleri kaybetmemek için PC'nize aktarmanız gerekir.", // from v2.1.44 added 1.12.2018
