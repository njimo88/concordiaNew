...
;(function (root, factory) {
    ...
    elFinder.prototype.i18.hu = {
        ...
        messages: {
            ...
            errUploadFileSize:
                'A fájl meghaladja a maximálisan megengedett méretet.', //  old name - errFileMaxSize
            ...
            errNoArchive:
                'A fájl nem archív, vagy nem támogatott archívumtípust tartalmaz.',
            errCmdNoSupport: 'A backend nem támogatja ezt a parancsot.',
            errReplByChild:
                'Az „$1” mappát nem lehet helyettesíteni egy abban található elemmel.',
            errArcSymlinks:
                'Biztonsági okokból az archívumok kicsomagolásának megtagadása szimbolikus linkeket vagy fájlokat tartalmaz, amelyek nem engedélyezettek.', // edited 24.06.2012
            errArcMaxSize:
                'Az archív fájlok meghaladják a megengedett legnagyobb méretet.',
            ...
            errNotUTF8Content:
                'Az "$1" fájl nincs az UTF-8-ban, és nem szerkeszthető.', // added 9.11.2011
            ...
            errFolderUpload:
                'Próbálja ki a Google Chrome-ot, ha szeretné feltölteni a mappát.', // from v2.1 added 26.6.2015
            errSearchTimeout:
                'Dőtúllépés a(z) "$1" keresése közben. A keresési eredmény részleges.', // from v2.1 added 12.1.2016
            ...
            confirmConvUTF8:
                'Nem UTF-8.<br/>Átalakítsam UTF-8-ra?<br/>A tartalom mentés után UTF-8 lesz..', // from v2.1 added 08.04.2014
            confirmNonUTF8:
            ...
            confirmNotSave:
                'Megváltozott.<br/>Módosítások elvesznek, ha nem menti el azokat.', // from v2.1 added 15.7.2015
            ...
            emptyFolderLTap:
                'A mappa üres\\Hosszú koppintás elemek hozzáadásához', // from v2.1.6 added 30.12.2015
            ...
            openMultiConfirm:
                'Megpróbálja megnyitni a $1 fájlokat. Biztosan meg akarja nyitni a böngészőben?', // from v2.1.12 added 5.14.2016
