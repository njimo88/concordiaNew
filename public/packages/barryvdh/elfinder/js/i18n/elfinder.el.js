...
;(function (root, factory) {
    ...
    elFinder.prototype.i18.el = {
        ...
        messages: {
            ...
            errNode:
                'το elFinder χρειάζεται να έχει δημιουργηθεί το DOM Element.',
            ...
            errCopyFrom:
                'Δεν επιτρέπεται η αντιγραφή αρχείων από το volume "$1".',
            ...
            errCopyInItself:
                'Δεν είναι δυνατή η αντιγραφή του "$1" στον εαυτό του.',
