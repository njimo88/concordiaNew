...
;(function (root, factory) {
    ...
    elFinder.prototype.i18.pt_BR = {
        ...
        messages: {
            ...
            errUploadTemp:
                'Incapaz de criar um arquivo temporário para upload.', // from v2.1 added 26.09.2015
            errNotReplace:
            ...
            errFtpMkdir:
                'Não foi possível criar um diretório remoto no FTP: "$1"',
            ...
            errEditorNotFound:
                'Editor não encontrado para este tipo de arquivo.', // from v2.1.25 added 23.5.2017
            ...
            confirmTrash:
                'Tem certeza de que deseja mover itens para a lixeira?', //from v2.1.24 added 29.4.2017
            ...
            emptyFolderLTap:
                'Pasta vazia\\A De um toque longo para adicionar itens', // from v2.1.6 added 30.12.2015
            ...
            incSearchOnly:
                'A pesquisa incremental é apenas da visualização atual.', // from v2.1.13 added 6.30.2016
            ...
            clearBrowserData:
                'Inicialize as configurações salvas neste navegador', // from v2.1.26 added 28.6.2017
            ...
            autoFocusDialog:
                'Focar no elemento do diálogo com o mouse por cima', // from v2.1.30 added 2.11.2017
