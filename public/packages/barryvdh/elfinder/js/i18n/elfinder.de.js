...
;(function (root, factory) {
    ...
    elFinder.prototype.i18.de = {
        translator:
            'JPG & Mace &lt;dev@flying-datacenter.de&gt;, tora60 from pragmaMx.org, Timo-Linde &lt;info@timo-linde.de&gt;, OSWorX &lt;info@osworx.net&gt;, Maximilian Schwarz &lt;info@deefuse.de&gt;, SF Webdesign &lt;webdesign@stephan-frank.de&gt;',
        language: 'Deutsch',
        direction: 'ltr',
        ...
        messages: {
            ...
            errPopup:
                'Der Browser hat das Pop-Up-Fenster unterbunden. Um die Datei zu öffnen, Pop-Ups in den Browsereinstellungen aktivieren.',
            ...
            errNoArchive:
                'Bei der Datei handelt es sich nicht um ein Archiv, oder die Archivart wird nicht unterstützt.',
            ...
            errNotUTF8Content:
                'Die Datei "$1" ist nicht im UTF-8-Format und kann nicht bearbeitet werden.', // added 9.11.2011
            ...
            errFtpMkdir:
                'Erstellung des Remote-Ordners mit FTP nicht möglich: "$1"',
            ...
            errFolderUpload:
                'Ordner kann nich hochladen werden, eventuell mit Google Chrome versuchen.', // from v2.1 added 26.6.2015
            errSearchTimeout:
            ...
            errRestore:
                'Datei konnte nicht aus Mülleimer wieder hergestellt werden bzw. Ziel für Wiederherstellung nicht gefunden.', // from v2.1.24 added 3.5.2017
            ...
            confirmRm:
                'Sollen die Dateien gelöscht werden?<br>Vorgang ist endgültig!',
            confirmRepl: 'Datei ersetzen?',
            confirmRest:
                'Vorhandenes Element durch das Element aus Mülleimer ersetzen?', // fromv2.1.24 added 5.5.2017
            confirmConvUTF8:
                'Nicht UTF-8 kodiert<br>Zu UTF-8 konvertieren?<br>Inhalte werden zu UTF-8 konvertiert bei Speicherung.', // from v2.1 added 08.04.2014
            confirmNonUTF8:
                'Die Zeichencodierung dieser Datei konnte nicht erkannt werden. Es muss vorübergehend in UTF-8 zur Bearbeitung konvertiert werden.<br> Bitte eine Zeichenkodierung dieser Datei auswählen.', // from v2.1.19 added 28.11.2016
            confirmNotSave:
                'Die Datei wurde geändert.<br>Änderungen gehen verloren wenn nicht gespeichert wird.', // from v2.1 added 15.7.2015
            ...
            emptyFolderDrop:
                'Der Ordner ist leer\\A Elemente durch Ziehen hinzufügen', // from v2.1.6 added 30.12.2015
            emptyFolderLTap:
                'Der Ordner ist leer\\A Elemente durch langes Tippen hinzufügen', // from v2.1.6 added 30.12.2015
            ...
            openMultiConfirm:
                'Es wird versucht die $1 Dateien zu öffnen .. sicher im Browser öffnen?', // from v2.1.12 added 5.14.2016
            ...
            autoFocusDialog:
                'Fokussierung auf das Element Dialog mit Mouseover', // from v2.1.30 added 2.11.2017
            ...
            renameMultiple:
                'Sicher $1 ausgewählte Elemente in $2 umbenennen?<br>Rückgängig nicht möglich!', // from v2.1.31 added 4.12.2017
            ...
            reflectOnImmediate:
                'Alle Änderungen werden sofort im Archiv angewendet.', // from v2.1.33 added 2.3.2018
            reflectOnUnmount:
                'Alle Änderungen werden nicht angewendet bis dieses Volume entfernt wird.', // from v2.1.33 added 2.3.2018
            unmountChildren:
                'Die folgenden Datenträger, die auf diesem Datenträger eingehängt sind, werden ebenfalls ausgehängt. Sicher dass alle aushängt werden sollen?', // from v2.1.33 added 5.3.2018
            ...
            editorConvNoApi:
                'Aktuell keine API zur Bearbeitung verfügbar, bitte auf Webseite bearbeiten', //from v2.1.40 added 13.12.2019
            editorConvNeedUpload:
                'Um zu speichern nach der Bearbeitung Element entweder mit URL hochladen oder mit herunter geladener Datei', // from v2.1.40 added 13.12.2019
            convertOn: 'Bearbeiten auf Seite $1', // from v2.1.40 added 13.12.2019
            integrations: 'Integrationen', // from v2.1.40 added 13.12.2019
            integrationWith:
                'Diese Software hat folgende externe Dienste integriert. Vor Anwendung bitte die jeweiligen Nutzungsbedingungen usw. beachten', // from v2.1.40 added 13.12.2019
            ...
            exportToSave:
                'Dieses Element kann nicht gespeichert werden. Um Änderungen nicht zu verlieren, muss es auf den lokalen PC exportiert werden', // from v2.1.44 added 13.12.2019
