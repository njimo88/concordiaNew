...
;(function (root, factory) {
    ...
    elFinder.prototype.i18.ro = {
        ...
        messages: {
            ...
            errLocked:
                '"$1" este blocat și nu poate fi redenumit, mutat sau șters.',
            ...
            errCopyFrom:
                'Copierea fișierelor de pe volumul "$1" este interzisă.',
            errCopyTo: 'Copierea fișierelor către volumul "$1" este interzisă.',
            errMkOutLink:
                'Nu am putut crea linkul în afara volumului rădăcină.', // from v2.1 added 03.10.2015
            ...
            errSessionExpires:
                'Sesiunea a expirat datorită lipsei de activitate.',
