...
;(function (root, factory) {
    ...
    elFinder.prototype.i18.uk = {
        ...
        messages: {
            ...
            errLocked:
                'Файл "$1" заблоковано і його неможливо перемістити, перейменувати чи вилучити.',
            ...
            errMkOutLink:
                'Неможливо створити посилання у місце за межами кореневої теки носія.', // from v2.1 added 03.10.2015
            ...
            errUploadTemp:
                'Неможливо створити тимчасовий файл для відвантаження.', // from v2.1 added 26.09.2015
            errNotReplace:
                'Об\'єкт "$1" вже існує тут та не може бути заміненим на об\'єкт іншого типу.', // new
            ...
            errArcSymlinks:
                'З міркувань безпеки заборонено розпаковувати архіви з символічними посиланнями.', // edited 24.06.2012
            ...
            errNotUTF8Content:
                'Файл "$1" не в UTF-8 і не може бути відредагований.', // added 9.11.2011
            ...
            errSearchTimeout:
                'Час пошуку "$1" вийшов. Результат пошуку частковий', // from v2.1 added 12.1.2016
            errReauthRequire: 'Необхідна повторна авторизація.', // from v2.1.10 added 24.3.2016
            errMaxTargets:
                "Максимальна кількість об'єктів що можна обрати складає $1.", // from v2.1.17 added 17.10.2016
            errRestore:
                'Неможливо відновити зі смітника: неможливо визначити місце куди відновлювати.', // from v2.1.24 added 3.5.2017
            ...
            confirmRm:
                'Ви справді хочете вилучити файли?<br/>Операція незворотня!',
            confirmRepl:
                "Замінити старий файл новим? (при наявності тек вони будуть об'єднані. Для резервної копії та заміни оберіть Резервну Копію)",
            confirmRest: "Замінити існуючий об'єкт об'єктом зі смітника?", // fromv2.1.24 added 5.5.2017
            confirmConvUTF8:
                'Не у UTF-8<br/>Конвертувати у UTF-8?<br/>Вміст стане у UTF-8 збереженням після конвертації.', // from v2.1 added 08.04.2014
            confirmNonUTF8:
                'Кодування символів цього файлу неможливо визначити. Потрібно тимчасово конвертувати його у UTF-8 для редагування.<br/>Оберіть кодування цього файлу.', // from v2.1.19 added 28.11.2016
            confirmNotSave:
                'Було внесено зміни.<br/>Якщо ії не зберегти, їх буде втрачено.', // from v2.1 added 15.7.2015
            confirmTrash:
                "Ви точно бажаєте перемістити ці об'єкти до смітника?", //from v2.1.24 added 29.4.2017
            ...
            dropPasteFiles:
                'Перетягніть файли, Вставте URL або світлини (з буфера обміну) сюди', // from v2.1 added 07.04.2014
            ...
            emptyFolderDrop:
                "Тека порожня\\A Перетягніть об'єкти для додавання", // from v2.1.6 added 30.12.2015
            emptyFolderLTap:
                "Тека порожня\\A Для додавання об'єктів торкніть та утримуйте", // from v2.1.6 added 30.12.2015
            ...
            openMultiConfirm:
                'Ви намагаєтесь відкрити $1 файлів. Ви впевнені що хочете відкрити ії у оглядачі?', // from v2.1.12 added 5.14.2016
            ...
            incSearchOnly:
                'Інкрементний пошук є тільки для поточного перегляду.', // from v2.1.13 added 6.30.2016
            ...
            emptyIncSearch:
                'Результати пошуку у поточному перегляді відсутні.\\AНатисніть [Enter] для розширення критеріїв пошуку.', // from v2.1.16 added 5.10.2016
            emptyLetSearch:
                'Результати пошуку за першою літерою відсутні у поточному перегляді.', // from v2.1.23 added 24.3.2017
            ...
            clearBrowserData:
                'Ініціювати налаштування збережені у цьому оглядачі', // from v2.1.26 added 28.6.2017
            ...
            autoFocusDialog:
                'Фокусувати елемент діалога при наведенні курсора миші', // from v2.1.30 added 2.11.2017
            select: 'Обрати', // from v2.1.30 added 23.11.2017
            selectAction: 'Дія при виборі файла', // from v2.1.30 added 23.11.2017
            useStoredEditor:
                'Відкрити редактором, що використовувався крайній раз.', // from v2.1.30 added 23.11.2017
            selectinvert: 'Інвертувати вибір', // from v2.1.30 added 25.11.2017
            renameMultiple:
                "Ви точно хочете перейменувати $1 обраних об'єктів на кшталт $2?<br/>Це незворотна дія!", // from v2.1.31 added 4.12.2017
            ...
            reflectOnImmediate:
                'Усі зміни будуть негайно застосовані у архіві.', // from v2.1.33 added 2.3.2018
            reflectOnUnmount:
                'Деякі зміни не буде видно до розмонтування носія.', // from v2.1.33 added 2.3.2018
            unmountChildren:
                'Наступний(і) носій(ї) на цьому носії також не змонтовані. Ви точно хочете відмонтувати носій?', // from v2.1.33 added 5.3.2018
            ...
            editorConvNoApi:
                'Через неможливість конвертування API, сконвертуйте на вебсайті.', //from v2.1.40 added 8.7.2018
            editorConvNeedUpload:
                'Після конвертування вам треба завантажити за допомогою URL або збереженого файу, для збереження конвертованого файлу.', //from v2.1.40 added 8.7.2018
            convertOn: 'Конвертувати сайт з $1', // from v2.1.40 added 10.7.2018
            integrations: 'Інтеграції', // from v2.1.40 added 11.7.2018
            integrationWith:
                'Цей elFinder має наступні інтегровані сервіси. Перевірте умови використання, політику приватності та інше перед використанням.', // from v2.1.40 added 11.7.2018
            ...
            exportToSave:
                "Об'єкт неможливо зберегти. Щоб уникнути втрати правок вам треба експортувати ії до себе у пристрій.", // from v2.1.44 added 1.12.2018
