...
;(function (root, factory) {
    ...
    elFinder.prototype.i18.fr = {
        ...
        messages: {
            ...
            errCmdReq:
                'La requête au Backend doit comporter le nom de la commande.',
            ...
            errLocked:
                '"$1" est verrouillé et ne peut être déplacé ou supprimé.',
            ...
            errCopyFrom:
                'Interdiction de copier des fichiers depuis le volume "$1".',
            errCopyTo:
                'Interdiction de copier des fichiers vers le volume "$1".',
            errMkOutLink:
            ...
            errUploadTotalSize:
                'Les données dépassent la taille maximale allouée.', // old name - errMaxSize
            ...
            errCmdNoSupport:
                'Le Backend ne prend pas en charge cette commande.',
            errReplByChild:
            ...
            errCreatingTempDir:
                'Impossible de créer le répertoire temporaire : "$1"',
            errFtpDownloadFile:
            ...
            errFolderUpload:
                'Essayez Google Chrome, si voulez envoyer le dossier.', // from v2.1 added 26.6.2015
            errSearchTimeout:
            ...
            emptySearch:
                'Aucun résultat trouvé avec les paramètres de recherche.', // from v2.1.12 added 5.16.2016
            ...
            emptyIncSearch:
                'Aucun résultat trouvé.\\Appuyez sur [Entrée] pour développer la cible de recherche.', // from v2.1.16 added 5.10.2016
            emptyLetSearch:
            ...
            tooManyToTrash:
                "Impossible de mettre autant d'éléments à la corbeille.", // from v2.1.25 added 9.6.2017
