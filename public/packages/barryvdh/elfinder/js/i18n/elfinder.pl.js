...
;(function (root, factory) {
    ...
    elFinder.prototype.i18.pl = {
        translator:
            'Marcin Mikołajczyk &lt;marcin@pjwstk.edu.pl&gt;, Bogusław Zięba &lt;bobi@poczta.fm&gt;, Bogusław Zięba &lt;bobi@poczta.fm&gt;',
        language: 'Polski',
        direction: 'ltr',
        ...
        messages: {
            ...
            errTrgFolderNotFound:
                'Katalog docelowy "$1" nie został znaleziony.',
            errPopup:
            ...
            errUploadTemp:
                'Nie można wykonać tymczasowego pliku do przesłania.', // from v2.1 added 26.09.2015
            errNotReplace:
            ...
            errArcMaxSize:
                'Archiwum przekracza maksymalny dopuszczalny rozmiar.',
            ...
            errNotUTF8Content:
                'Plik "$1" nie jest UTF-8 i nie może być edytowany.', // added 9.11.2011
            ...
            errFolderUpload:
                'Wypróbuj Google Chrome, jeśli chcesz przesłać katalog.', // from v2.1 added 26.6.2015
            errSearchTimeout:
            ...
            emptyFolderLTap:
                'Katalog jest pusty\\ADotknij dłużej aby dodać pozycje', // from v2.1.6 added 30.12.2015
            ...
            clearBrowserData:
                'Zainicjuj ustawienia zapisane w tej przeglądarce', // from v2.1.26 added 28.6.2017
            ...
            reflectOnImmediate:
                'Wszystkie zmiany widoczne natychmiast w archiwum.', // from v2.1.33 added 2.3.2018
            reflectOnUnmount:
            ...
            makefileTypes:
                'Typy plików, które można włączyć za pomocą "Nowy plik"', // from v2.1.41 added 7.8.2018
