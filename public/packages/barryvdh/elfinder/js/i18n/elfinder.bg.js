...
;(function (root, factory) {
    ...
    elFinder.prototype.i18.bg = {
        ...
        messages: {
            ...
            errUploadTotalSize:
                'Данните превишават максимално допостумия размер.', // old name - errMaxSize
            ...
            errCreatingTempDir:
                'Не може да се създаде временна директория: "$1"',
            ...
            errFolderUpload:
                'Опитайте Google Chrome, ако искате да качите папка.', // from v2.1 added 26.6.2015
            errSearchTimeout:
            ...
            confirmRest:
                'Да се замени ли съществуващата позиция с тази в кошчето?', // fromv2.1.24 added 5.5.2017
            confirmConvUTF8:
            ...
            tooManyToTrash:
                'Прекалено много позиции, не може да премести в кошчето.', // from v2.1.25 added 9.6.2017
            ...
            clearBrowserData:
                'Инициализирайте настройките запаметени в този браузър', // from v2.1.26 added 28.6.2017
            ...
            reflectOnImmediate:
                'Всички промени ще се отразят незабавно в архива.', // from v2.1.33 added 2.3.2018
            reflectOnUnmount:
