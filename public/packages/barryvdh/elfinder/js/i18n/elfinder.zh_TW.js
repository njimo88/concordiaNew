...
;(function (root, factory) {
    ...
    elFinder.prototype.i18.zh_TW = {
        ...
        messages: {
            ...
            errArcSymlinks:
                '由於安全考量，拒絕解壓縮符號連結或含有不允許檔名的檔案.', // edited 24.06.2012
            ...
            emptyIncSearch:
                '目前視圖的搜尋結果是空的.\\A按 [Enter] 擴大搜尋目標.', // from v2.1.16 added 5.10.2016
            ...
            editorConvNoApi:
                '由於使用 API 轉換功能目前無法使用，請到網站上轉換.', //from v2.1.40 added 8.7.2018
            ...
            exportToSave:
                '檔案無法存檔，為避免遺失編輯資料，需要導出到你的電腦.', // from v2.1.44 added 1.12.2018
