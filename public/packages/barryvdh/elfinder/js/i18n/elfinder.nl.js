...
;(function (root, factory) {
    ...
    elFinder.prototype.i18.nl = {
        ...
        messages: {
            ...
            errNoArchive:
                'Bestand is geen archief of geen ondersteund archief type',
            ...
            errFtpDownloadFile:
                'Kan het bestand niet downloaden vanaf FTP: "$1"',
            errFtpUploadFile: 'Kan het bestand niet uploaden naar FTP: "$1"',
            errFtpMkdir:
                'Kan het externe map niet aanmaken op de FTP-server: "$1"',
            errArchiveExec:
            ...
            emptyFolderDrop:
                'Map is leeg\\A Sleep hier naar toe om toe te voegen', // from v2.1.6 added 30.12.2015
            emptyFolderLTap:
                'Map is leeg\\A Lang ingedrukt houden om toe te voegen', // from v2.1.6 added 30.12.2015
            ...
            reflectOnImmediate:
                'Aanpassingen worden direct toegepast op het archief', // from v2.1.33 added 2.3.2018
            reflectOnUnmount:
