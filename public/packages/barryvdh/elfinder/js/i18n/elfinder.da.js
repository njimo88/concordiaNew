...
;(function (root, factory) {
    ...
    elFinder.prototype.i18.da = {
        translator:
            'Mark Topper (webman.io), Helmuth Mikkelsen &lt;helmuthm@gmail.com&gt;',
        language: 'Danish',
        direction: 'ltr',
        ...
        messages: {
            ...
            errJqui:
                'Ugyldig jQuery UI-konfiguration. Valgbare, trækbare og dropbare komponenter skal medtages.',
            ...
            errPopup:
                'Browser forhindrede åbning af pop up-vindue. For at åbne filen skal du aktivere den i browserindstillinger.',
            errMkdir: 'Kunne ikke oprette mappen "$1".',
            errMkfile: 'Kunne ikke oprette filen "$1".',
            errRename: 'Kunne ikke omdøbe "$1".',
            errCopyFrom:
                'Kopiering af filer fra diskenhed "$1" er ikke tilladt.',
            errCopyTo: 'Kopiering af filer til diskenhed "$1" er ikke tilladt.',
            errMkOutLink:
                'Kan ikke oprette et link til uden for diskenhedsroden.', // from v2.1 added 03.10.2015
            ...
            errUploadTotalSize:
                'Data overskrider den maksimalt tilladte størrelse.', // old name - errMaxSize
            errUploadFileSize:
                'Fil overskrider den maksimalt tilladte størrelse.', //  old name - errFileMaxSize
            ...
            errNotReplace:
                'Objekt "$1" findes allerede på dette sted og kan ikke erstattes af objekt med en anden type.', // new
            ...
            errNoArchive:
                'Filen er ikke et arkiv eller har ien kke-understøttet arkivtype.',
            errCmdNoSupport: 'Backend understøtter ikke denne kommando.',
            errReplByChild:
                'Mappen "$1" kan ikke erstattes af et element, den indeholder.',
            errArcSymlinks:
                'Af sikkerhedsmæssige årsager nægtes at udpakke arkiver der indeholder symlinks eller filer med ikke-tilladte navne.', // edited 24.06.2012
            errArcMaxSize:
                'Arkivfiler overskrider den maksimalt tilladte størrelse.',
            ...
            errFolderUpload:
                'Prøv den nyeste browser, hvis du vil uploade mappen.', // from v2.1 added 26.6.2015
            errSearchTimeout:
                'Time out under søgning på "$1". Søgeresultatet er delvis.', // from v2.1 added 12.1.2016
            ...
            errRestore:
                'Kan ikke gendannes fra papirkurven. Kan ikke identificere gendannelsesdestinationen.', // from v2.1.24 added 3.5.2017
            ...
            confirmRm:
                'Er du sikker på du vil slette valgte filer?<br/>Dette kan ikke fortrydes!',
            confirmRepl: 'Erstat gammel fil med ny fil?',
            confirmRest:
                'Erstat eksisterende element med elementet i papirkurven?', // fromv2.1.24 added 5.5.2017
            confirmConvUTF8:
                'Ikke i UTF-8<br/>Konverter til UTF-8?<br/>Indholdet bliver UTF-8 ved at gemme efter konvertering.', // from v2.1 added 08.04.2014
            confirmNonUTF8:
                'Tegnkodning af denne fil kunne ikke registreres. Det er nødvendigt at konvertere midlertidigt til UTF-8 til redigering.<br/>Vælg tegnkodning af denne fil.', // from v2.1.19 added 28.11.2016
            confirmNotSave:
                'Det er blevet ændret.<br/>Du mister arbejde, hvis du ikke gemmer ændringer.', // from v2.1 added 15.7.2015
            confirmTrash:
                'Er du sikker på, at du vil flytte emner til papirkurven?', //from v2.1.24 added 29.4.2017
            ...
            dropPasteFiles:
                'Slip filer, indsæt webadresser eller billeder (udklipsholder) her', // from v2.1 added 07.04.2014
            ...
            openMultiConfirm:
                'Du prøver at åbne $1-filerne. Er du sikker på, at du vil åbne i browseren?', // from v2.1.12 added 5.14.2016
            ...
            incSearchOnly:
                'Inkrementel søgning er kun fra den aktuelle visning.', // from v2.1.13 added 6.30.2016
            ...
            emptyIncSearch:
                'Søgeresultaterne er tomme i den aktuelle visning.\\ATryk på [Enter] for at udvide søgemålet.', // from v2.1.16 added 5.10.2016
            emptyLetSearch:
                'Førstebogstavs søgeresultater er tomme i den aktuelle visning.', // from v2.1.23 added 24.3.2017
            ...
            tooManyToTrash:
                'Det er for mange emner, så det kan ikke komme i papirkurven.', // from v2.1.25 added 9.6.2017
            ...
            clearBrowserData:
                'Initialiser de indstillinger, der er gemt i denne browser', // from v2.1.26 added 28.6.2017
            ...
            renameMultiple:
                'Er du sikker på, at du vil omdøbe $1 valgte emner som $2?<br/>Dette kan ikke fortrydes!', // from v2.1.31 added 4.12.2017
            ...
            reflectOnUnmount:
                'Eventuelle ændringer gennemføres ikke, før denne enhed fjernes.', // from v2.1.33 added 2.3.2018
            unmountChildren:
                'Følgende disk(e) mounted på denne enhed unmountes også. Er du sikker på at unmounte den?', // from v2.1.33 added 5.3.2018
            ...
            editorConvNoApi:
                'Da konvertering via API ikke er tilgængelig i øjeblikket, bedes du konvertere på webstedet.', //from v2.1.40 added 8.7.2018
            editorConvNeedUpload:
                'Efter konvertering skal du uploade med elementets URL eller en downloadet fil for at gemme den konverterede fil.', //from v2.1.40 added 8.7.2018
            convertOn: 'Konverter på stedet på $1', // from v2.1.40 added 10.7.2018
            integrations: 'Integrationer', // from v2.1.40 added 11.7.2018
            integrationWith:
                'Denne elFinder har følgende eksterne tjenester integreret. Kontroller venligst vilkårene for brug, fortrolighedspolitik osv. inden du bruger det.', // from v2.1.40 added 11.7.2018
            ...
            exportToSave:
                'Dette element kan ikke gemmes. For at undgå at miste redigeringerne skal du eksportere til din pc.', // from v2.1.44 added 1.12.2018
