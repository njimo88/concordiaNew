!(function (global, factory) {
    ...
    var _default$6 = (function () {
        ...
        store$2 = {
            ...
            getClosestParentId: function (childId, subsetOfParentIds) {
                ...
                return (
                    Object.entries(distancesByParentId).forEach(
                        function (_ref3) {
    ...
    var checkCorrectnessOfIteration = function (exec, SKIP_CLOSING) {
        ...
        INCORRECT_ITERATION$1 = !checkCorrectnessOfIteration(
            function (iterable) {
                Array.from(iterable)
            },
        )
    ...
    function removeLoadingEl(component, el) {
        component.genericLoadingEls.forEach(function (element, index) {
            ...
            Object.keys(component.targetedLoadingElsByAction).forEach(
                function (key) {
                    component.targetedLoadingElsByAction[key] =
                        component.targetedLoadingElsByAction[key].filter(
                            function (element) {
            ...
            return (
                _createClass(UploadManager, [
                    ...
                    },
                    {
                        key: 'startUpload',
                        value: function (name, uploadObject) {
                            var fileInfos = uploadObject.files.map(
                                function (file) {
                                    return {
                                        name: file.name,
                                        size: file.size,
        ...
        return (
            _createClass(Component, [
                ...
                },
                {
                    key: 'get',
                    value: function (name) {
                        return name.split('.').reduce(function (
                            carry,
                            segment,
                        ) {
                        ...
                        this.updateServerMemoFromResponseAndMergeBackIntoResponse(
                            ...
                            message.replaying ||
                                ...
                                response.effects.emits &&
                                    ...
                                    response.effects.emits.forEach(
                                        function (event) {
                ...
                },
                {
                    ...
                    value: function (callback) {
                        this.modelDebounceCallbacks &&
                            this.modelDebounceCallbacks.forEach(
                        ...
                        ;['channel', 'private', 'encryptedPrivate'].includes(
                            ...
                            : 'presence' == channel_type
                              ...
                              : 'notification' == channel_type
                                ? Echo.private(channel).notification(
    ...
    function toggleOffline(el, isOffline) {
        ...
        if (directive.modifiers.includes('class')) {
            ...
            directive.modifiers.includes('attr')
                ? directive.modifiers.includes('remove') !== isOffline
                    ? el.setAttribute(directive.value, !0)
                    : el.removeAttribute(directive.value)
                : directives.get('model') ||
                    ...
                    },
                    {
                        ...
                        value: function (signature, response, component) {
                            var _this = this,
                                ...
                                existingIndex = this.items.findIndex(
                                    function (item) {
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            return this.items.map(function (_ref2) {
                                ...
                                return _this3.parseSignature(signature)
                                    .originalComponentId
                            })
                        },
                    },
