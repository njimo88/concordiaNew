                    ...
                    'html5' == x && 0 == a.find(y).length
                        ...
                        : 'youtube' == x && 0 == a.find('iframe').length
                          ...
                          : 'vimeo' == x && 0 == a.find('iframe').length
                            ...
                            : 'none'
            switch (
                ((w = l.nextslideatend === !0 ? '' : w), (l.videotype = x), z)
            ) {
                case 'html5':
                    'controls' != u && (u = '')
                    var y = 'video'
                    'html5' == l.audio &&
                        ((y = 'audio'), a.addClass('tp-audio-html5'))
                    var A =
                        '<' +
                        y +
                    ...
                    ;('true' !== t && t !== !0) ||
                        ...
                        a.append(A),
                        ((c && 1 == a.data('disablevideoonmobile')) ||
                            b.isIE(8)) &&
                            a.find(y).remove(),
        ...
        h = function (a, d, f) {
            ...
            if (
                ...
                switch (h.videotype) {
                                ...
                                onStateChange: function (c) {
                                    ...
                                    if (c.data == YT.PlayerState.PLAYING)
                                        ...
                                        !q &&
                                            (0 == c.data || 2 == c.data) &&
                                            'on' ==
                                                a.data('showcoveronpause') &&
                                            a.find('.tp-videoposter').length >
                                                0 &&
                                            (punchgs.TweenLite.to(
                                                a.find('.tp-videoposter'),
                                                0.3,
                    ...
                    case 'vimeo':
                        for (
                            ...
                            t[decodeURIComponent(w[1])] = decodeURIComponent(
                                w[2],
                            )
                        s =
                            void 0 != t.player_id
                ...
                switch (h.videotype) {
                    case 'youtube':
                        f &&
                            (h.player.playVideo(), z != -1 && h.player.seekTo())
                        break
                    case 'vimeo':
                        if (f) {
        ...
        l = function (a, c) {
            void 0 == c.playingvideos && (c.playingvideos = new Array()),
                a.data('stopallvideos') &&
                    ...
                    ((c.lastplayedvideos = jQuery.extend(
                        !0,
                        [],
                        c.playingvideos,
                    )),
