...
!(function (a) {
    ...
    jQuery.extend(!0, b, {
            ...
            if (!c.frames_added) {
                if (
                    ...
                    for (var i = 0; i < c.frames.length; i++)
                        void 0 === c.frames[0].from &&
                            (c.frames[0].from = 'o:inherit'),
        ...
        animateTheCaptions: function (a) {
            ...
            if (
                ...
                (c.layers.static =
                    c.layers.static ||
                    c.c.find('.tp-static-layers').find('.tp-caption')),
            ...
            var n =
                c.nextSlide === -1 || void 0 === c.nextSlide ? 0 : c.nextSlide
                ...
                h ||
                    (void 0 !== i &&
                        ...
                        c.timelines.staticlayers &&
                            jQuery.each(
                                c.timelines.staticlayers.layers,
                                function (a, d) {
                                    var e = d.layer.data(),
                                        f =
                                            n >= d.firstslide &&
                                        ...
                                        h = d.timeline.getLabelTime(
                                            'slide_' + d.firstslide,
                                        ),
                                        i = d.timeline.getLabelTime(
                                            'slide_' + d.lastslide,
                                        ),
        ...
        prepareSingleCaption: function (a) {
            ...
            if (
                ((d._pw =
                    void 0 === d._pw ? c.closest('.tp-parallax-wrap') : d._pw),
                ...
                (d._isgroup =
                    void 0 === d._isgroup
                        ? !!c.hasClass('rev_group')
                        : d._isgroup),
                (d._nctype = d.type || 'none'),
                (d._cbgc_auto =
                    void 0 === d._cbgc_auto
                        ? 'column' === d._nctype &&
                          d._pw.find('.rev_column_bg_auto_sized')
                        : d._cbgc_auto),
                (d._cbgc_man =
                    void 0 === d._cbgc_man
                        ? 'column' === d._nctype &&
                          d._pw.find('.rev_column_bg_man_sized')
                        : d._cbgc_man),
                (d._slideid =
                    d._slideid ||
                    c.closest('.tp-revslider-slidesli').data('index')),
                (d._id =
                    void 0 === d._id ? c.data('id') || c.attr('id') : d._id),
                (d._slidelink =
                    void 0 === d._slidelink
                        ? void 0 !== c.hasClass('slidelink') &&
                          c.hasClass('slidelink')
                        : d._slidelink),
                void 0 === d._li &&
                ...
                'fullscreen' == e.sliderLayout &&
                    (a.offsety =
                        d._gh / 2 - (e.gridheight[e.curWinRange] * e.bh) / 2),
                ('on' == e.autoHeight ||
                    (void 0 != e.minHeight && e.minHeight > 0)) &&
                    (a.offsety =
                        e.conh / 2 - (e.gridheight[e.curWinRange] * e.bh) / 2),
            ...
            if (
                ...
                ;(q =
                    o(n.data('ww'), e)[e.curWinRange] ||
                    o(n.data('ww'), e) ||
                    'auto'),
                    (t =
                        o(n.data('hh'), e)[e.curWinRange] ||
                        o(n.data('hh'), e) ||
                        'auto')
            ...
            if ('slide' === d._ba) (a.offsetx = 0), (a.offsety = 0)
                ...
                switch (e.carousel.horizontal_align) {
                    case 'center':
                        a.offsetx =
                            0 + (e.ulw - e.gridwidth[e.curWinRange] * e.bw) / 2
                        break
                    case 'left':
                        break
                    case 'right':
            ...
            if (
                ...
                if (
                    ...
                    punchgs.TweenLite.set(c, {
                        ...
                        paddingBottom:
                            Math.round(G.paddingBottom * e.bh) + 'px',
                        ...
                        borderTopWidth:
                            Math.round(G.borderTopWidth * e.bh) + 'px',
                        borderBottomWidth:
                            Math.round(G.borderBottomWidth * e.bh) + 'px',
                        borderLeftWidth:
                            Math.round(G.borderLeftWidth * e.bw) + 'px',
                        borderRightWidth:
                            Math.round(G.borderRightWidth * e.bw) + 'px',
                        width: q,
                        height: t,
                    })
                ;((0 == E && !F) ||
                    (1 != d.forcecover &&
                        !c.hasClass('fullscreenvideo') &&
                        !F)) &&
            ...
            p(c, '.frontcorner', 'left', 'borderRight', 'borderTopColor', I, J),
                ...
                'on' == e.fullScreenAlignForce &&
                    ((a.offsetx = 0), (a.offsety = 0)),
                (d.arrobj = new Object()),
                (d.arrobj.voa =
                    o(d.voffset, e)[e.curWinRange] || o(d.voffset, e)[0]),
                (d.arrobj.hoa =
                    o(d.hoffset, e)[e.curWinRange] || o(d.hoffset, e)[0]),
                ...
                a.c
                    ...
                    .each(function () {
                        ...
                        ;(a.timelines[d] = a.timelines[d] || {}),
                            (a.timelines[d].layers =
                                a.timelines[d].layers || new Object()),
            ...
            if (
                ...
                if (
                    ...
                    if (
                        ...
                        (d.hoveranim = q(
                            d.hoveranim,
                            d.frames[d.hoverframeindex].style,
                        )),
                        i.svg)
                    ) {
        ...
        createFrameOnTimeline: function (a) {
            ...
            if (
                ...
                void 0 === g.vars.id &&
                    (g.vars.id = Math.round(1e5 * Math.random())),
                'column' === d._nctype &&
                    (g.add(
            ...
            if (
                ...
                h === d.outframeindex &&
                    ...
                    (t.speed =
                        void 0 === d.frames[h].speed ||
                        'inherit' === d.frames[h].speed
                            ? d.frames[d.inframeindex].speed
                            : d.frames[h].speed),
                    (t.anim.ease =
                        void 0 === d.frames[h].ease ||
                        'inherit' === d.frames[h].ease
            ...
            return (
                ...
                (0 === h && a.ignorefirstframe)
                    ...
                    : 0 === h &&
                      g.add(o.mask.set(d._mw, { overflow: 'visible' }), e),
                ...
                o.content.eventCallback(
                    ...
                    function (a, c, d, e, f, g, h, i) {
                        ...
                        punchgs.TweenLite.set(d, { visibility: 'visible' }),
                            ...
                            i &&
                                (e.static_layer_timeline_time =
                                    e.current_timeline_time),
                ...
                o.content.eventCallback(
                    ...
                    function (a, d, e, f, g, h, i) {
                        ...
                        ;(k.layer = c),
                            ...
                            i &&
                                (g.static_layer_timeline_time =
                                    g.current_timeline_time)
                    },
                    [
                        h,
                        d.frames.length,
    ...
    var e = function (a) {
            ...
            return (
                (a.firstframe =
                    void 0 === a.firstframe ? 'frame_0' : a.firstframe),
                (a.lastframe =
                    void 0 === a.lastframe ? 'frame_999' : a.lastframe),
        ...
        f = function (a) {
            return (
                ...
                (a.anim.rotationX =
                    void 0 === a.anim.rotationX ? 0 : a.anim.rotationX),
                (a.anim.rotationY =
                    void 0 === a.anim.rotationY ? 0 : a.anim.rotationY),
                (a.anim.rotationZ =
                    void 0 === a.anim.rotationZ ? 0 : a.anim.rotationZ),
                ...
                (a.anim.opacity =
                    void 0 === a.anim.opacity ? 1 : a.anim.opacity),
                ...
                (a.anim.transformPerspective =
                    void 0 === a.anim.transformPerspective
                        ...
                        : a.anim.transformPerspective),
                (a.anim.rotation =
                    void 0 === a.anim.rotation ? 0 : a.anim.rotation),
                (a.anim.force3D =
                    void 0 === a.anim.force3D ? 'auto' : a.anim.force3D),
                (a.anim.autoAlpha =
                    void 0 === a.anim.autoAlpha ? 1 : a.anim.autoAlpha),
                (a.anim.visibility =
                    void 0 === a.anim.visibility
                        ? 'visible'
                        : a.anim.visibility),
                (a.anim.overwrite =
                    ...
                    jQuery.each(e, function (a, b) {
                        ...
                        c &&
                            ...
                            void 0 != h &&
                                ...
                                ('rotationX' != g && 'rX' != g) ||
                                    (d.anim.rotationX =
                                        k(h, d.anim.rotationX) + 'deg'),
                                ('rotationY' != g && 'rY' != g) ||
                                    (d.anim.rotationY =
                                        k(h, d.anim.rotationY) + 'deg'),
                                ('rotationZ' != g && 'rZ' != g) ||
                                    (d.anim.rotation =
                                        k(h, d.anim.rotationZ) + 'deg'),
                                ('scaleX' != g && 'sX' != g) ||
                                ...
                                ('speed' != g && 's' != g) ||
                                    (d.speed = parseFloat(h)))
                    }),
                '' !== f &&
                    ((d.anim['-webkit-filter'] = f), (d.anim.filter = f)),
                d
            )
        },
        n = function (a) {
        ...
        r = function (a, b) {
            ...
            if (
                ...
                (c.zIndex = d
                    ...
                    : void 0 === a.data('zIndex')
                      ...
                      : a.data('zIndex')),
                jQuery.inArray(a.data('layertype'), [
                    'video',
                    'image',
                    'audio',
                ]) !== -1 || a.is('img')
                ...
                ;(c.maxWidth =
                    ...
                    (c.moan =
                        void 0 === a.data('moan')
                            ? parseInt(a.css('-moz-animation-transition'), 0) ||
                              'none'
                            : a.data('moan')),
                    (c.man =
                        void 0 === a.data('man')
                            ? parseInt(a.css('-ms-animation-transition'), 0) ||
                              'none'
                            : a.data('man')),
                    (c.ani =
                        void 0 === a.data('ani')
            ...
            return (
                ...
                '' == c.styleProps.color &&
                    (c.styleProps.color = a.css('color')),
                c
            )
        },
        s = function (a, b) {
            ...
            if (
                ...
                if (
                    ...
                    punchgs.TweenLite.set(a, {
                        ...
                        borderBottomWidth:
                            Math.round(f.borderBottomWidth * h) + 'px',
                        borderLeftWidth:
                            Math.round(f.borderLeftWidth * g) + 'px',
                        borderRightWidth:
                            Math.round(f.borderRightWidth * g) + 'px',
                    ...
                    var j =
                            'slide' == f.basealign
                                ? b.ulw
                                : b.gridwidth[b.curWinRange],
                        k =
                            'slide' == f.basealign
                                ? b.ulh
                                : b.gridheight[b.curWinRange],
                ...
                'column' === e._nctype &&
                    ...
                    e._cbgc_auto &&
                        ((e._cbgc_auto[0].style.backgroundSize =
                            e._column_bg_image_size),
                        jQuery.isArray(f.marginLeft)
                            ? punchgs.TweenLite.set(e._cbgc_auto, {
                                  borderTopWidth:
                                      f.marginTop[b.curWinRange] * h + 'px',
                                  borderLeftWidth:
                                      f.marginLeft[b.curWinRange] * g + 'px',
                                  borderRightWidth:
                                      f.marginRight[b.curWinRange] * g + 'px',
                                  borderBottomWidth:
                                      f.marginBottom[b.curWinRange] * h + 'px',
        ...
        v = function (a, b) {
            ...
            if (c._cbgc_man) {
                ...
                jQuery.isArray(c.cssobj.marginLeft)
                    ...
                    (c._cbgc_man[0].style.backgroundSize =
                        c._column_bg_image_size),
        ...
        w = function (a, b) {
            ...
            if (a.hasClass('rs-wave') && void 0 == c._loop_timeline) {
                ...
                var o =
                        void 0 == a.data('angle')
                            ? 10
                            : parseInt(a.data('angle'), 0),
                    p =
                        void 0 == a.data('radius')
                            ? 10
                            : parseInt(a.data('radius'), 0),
