...
!(function (t) {
    ...
    var o = function (t) {
            ...
            if (
                ...
                var o = new Object()
                if (
                    'solo' == t.navigationArrows ||
                    'nextto' == t.navigationArrows
                ) {
                    var e = new Object()
                    ;(e.enable = !0),
                        (e.style = t.navigationStyle || ''),
                        (e.hide_onmobile =
                            'on' === t.hideArrowsOnMobile ? !0 : !1),
                ...
                ;(t.navigation = o),
                    (t.navigation.keyboardNavigation =
                        t.keyboardNavigation || 'on'),
                ...
                void 0 == t.fallbacks &&
                    (t.fallbacks = {
                        ...
                        panZoomDisableOnMobile:
                            t.parallaxDisableOnMobile || 'off',
                        simplifyAll: t.simplifyAll || 'on',
                        nextSlideOnWindowFocus:
                            t.nextSlideOnWindowFocus || 'off',
