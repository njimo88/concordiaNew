...
!(function (jQuery, undefined) {
    ...
    jQuery.extend(!0, _R, {
        ...
        setSize: function (a) {
            var b = (a.top_outer || 0) + (a.bottom_outer || 0),
                ...
                f = 0,
                g =
                    a.nextSlide === -1 || a.nextSlide === undefined
                        ? 0
                        : a.nextSlide
            if (
                ((a.paddings =
    ...
    var _ISM = _R.is_mobile(),
                ...
                ('undefined' != typeof punchgs &&
                    ...
                    (!d.carousel ||
                        (d.carousel &&
                            'undefined' != typeof _R.prepareCarousel)) &&
                    (!d.videos ||
                        (d.videos && 'undefined' != typeof _R.resetVideo)) &&
                    (!d.actions ||
            ...
            if (
                ...
                jQuery(window).on(t, function () {
                    ...
                    if ('fullscreen' == b.sliderLayout) {
                        ...
                        ;('mobile' == b.fallbacks.ignoreHeightChanges &&
                            _ISM) ||
                ...
                d.index() === c.index() && b.onlyPreparedSlide !== !0
                    ...
                    : (b.onlyPreparedSlide === !0 &&
                      ...
                      void waitForCurrentImages(d, b, function () {
                          d
                              .find('.rs-background-video-layer')
                              .each(function () {
                                  var a = jQuery(this)
                                  a.hasClass('HasListener') ||
                                      (a.data('bgvideo', 1),
                                      _R.manageVideoLayer &&
                                          _R.manageVideoLayer(a, b)),
                                      0 ==
        ...
        letItFree = function (a, b, c, d, e, f) {
            ...
            var k =
                g.nextSlide === -1 || g.nextSlide === undefined
                    ? 0
                    : g.nextSlide
